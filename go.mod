...
require (
	...
	github.com/elastic/package-spec/v3 v3.5.8 // indirect
...
replace github.com/elastic/elastic-package => github.com/MichelLosier/elastic-package v0.0.0-20260313195335-c1fc11f3921b
