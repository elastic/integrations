...
require (
	...
	github.com/elastic/package-spec/v3 v3.0.3 // indirect
...
replace github.com/elastic/package-spec/v3 => github.com/jillguyonnet/package-spec/v3 v3.0.0-20240111132229-2990c34ad272
