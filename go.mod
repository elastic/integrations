...
require (
	...
	github.com/elastic/package-registry v1.30.1
...
replace github.com/elastic/elastic-package => github.com/jsoriano/elastic-package v0.66.1-0.20250730160816-56c8aee45377
