...
require (
	...
	github.com/elastic/package-spec/v2 v2.8.0 // indirect
...
replace github.com/elastic/elastic-package => github.com/mrodm/elastic-package v0.53.1-0.20230525103438-71c1c3b7696f
