...
require (
	...
	github.com/elastic/package-spec/v3 v3.6.1 // indirect
	...
	go.elastic.co/apm/module/apmgorilla/v2 v2.7.6 // indirect
	go.elastic.co/apm/module/apmhttp/v2 v2.7.6 // indirect
	go.elastic.co/apm/module/apmzap/v2 v2.7.6 // indirect
...
replace github.com/elastic/elastic-package => github.com/teresaromero/elastic-package v0.0.0-20260422085533-8a9af9469b13
