...
require (
	...
	github.com/elastic/package-spec/v3 v3.2.0 // indirect
...
replace github.com/elastic/elastic-package => github.com/mrodm/elastic-package v0.53.1-0.20240619153519-f9ffd443b8cb
