...
require (
	...
	github.com/elastic/elastic-package v0.48.0
...
replace github.com/elastic/elastic-package => github.com/jsoriano/elastic-package v0.0.0-20220406102802-f40d12262bac
