...
require (
	...
	github.com/elastic/package-spec/v2 v2.8.1 // indirect
...
replace github.com/elastic/elastic-package => github.com/mrodm/elastic-package v0.53.1-0.20230620075529-d7fb416b3a17
