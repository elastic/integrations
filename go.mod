...
require (
	...
	github.com/fsouza/fake-gcs-server v1.50.2 // indirect
...
replace github.com/elastic/elastic-package => github.com/jsoriano/elastic-package v0.66.1-0.20241122121412-dc741acbeab1
