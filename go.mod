...
require (
	...
	github.com/elastic/package-registry v1.30.0
...
replace github.com/elastic/package-spec/v3 => github.com/MichelLosier/package-spec/v3 v3.0.0-20250718222109-2056661dbe46
