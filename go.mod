...
require (
	...
	go.elastic.co/apm/module/apmgorilla/v2 v2.6.3 // indirect
...
replace github.com/elastic/package-spec/v3 => github.com/patrykkopycinski/package-spec/v3 v3.0.0-20250211103226-45b69849daeb
