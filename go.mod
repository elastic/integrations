...
require (
	...
	github.com/elastic/package-spec/v3 v3.5.6 // indirect
...
replace github.com/elastic/elastic-package => github.com/teresaromero/elastic-package v0.0.0-20260218115053-faf987ce2621
