...
require (
	...
	github.com/elastic/package-spec/v3 v3.2.1 // indirect
...
replace github.com/elastic/elastic-package => github.com/jsoriano/elastic-package v0.66.1-0.20240703212245-100eb28d3a9a
