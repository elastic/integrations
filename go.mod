...
require (
	...
	github.com/elastic/elastic-package v0.47.1
...
replace github.com/elastic/package-spec => github.com/andrewkroh/package-spec v0.0.0-20220429132035-2baa12cfb3a4
