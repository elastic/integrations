...
require (
	...
	github.com/elastic/package-spec/v2 v2.12.0 // indirect
...
replace github.com/elastic/elastic-package => github.com/jsoriano/elastic-package v0.66.1-0.20230926163427-353c719ac14d
