...
This input package enables consumption of telemetry data (logs, metrics, and traces) from Apache Kafka using the [Kafka receiver](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/receiver/kafkareceiver) from the OpenTelemetry Collector Contrib project.
