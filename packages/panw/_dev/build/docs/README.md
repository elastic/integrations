...
- This module has been tested with logs generated by devices running PAN-OS versions 8.1 to 11.0 but limited compatibility is expected for earlier versions.
