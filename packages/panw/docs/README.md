...
| panw.panos.event.code | A string showing the action of the event. | keyword |
| panw.panos.event.id | A string showing the identification code for the event. | keyword |
