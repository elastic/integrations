...
| trend_micro_vision_one.network_activity.user.principal_name | User principal name used to log on to TrendAI Web Security admin portal. | keyword |
...
```json
{
    ...
    "trend_micro_vision_one": {
        "telemetry": {
            ...
            "event_source_type": 1,
            "event_sub_id": 109,
            "event_subtype": "TELEMETRY_FILE_MODIFY",
            "event_time": "2025-03-03T23:53:20.111Z",
            "event_type": "TELEMETRY_FILE",
