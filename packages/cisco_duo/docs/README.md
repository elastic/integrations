...
```json
{
    ...
    "agent": {
        "ephemeral_id": "af1c4c4a-925f-44eb-893c-69d7e3f9f304",
        "id": "60f616ab-0309-4ea6-bc12-8cc7f8c44621",
    ...
    "event": {
        ...
        "created": "2022-07-13T09:42:01.823Z",
        "dataset": "cisco_duo.admin",
        "ingested": "2022-07-13T09:42:02Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "9a3c5ac2-9401-40a2-a99c-45c6221dcc56",
        "id": "60f616ab-0309-4ea6-bc12-8cc7f8c44621",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.2.0"
    ...
    "event": {
        ...
        "created": "2022-07-13T09:43:30.116Z",
        "dataset": "cisco_duo.auth",
        "ingested": "2022-07-13T09:43:31Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "f1f5f6fc-f64b-4698-9b80-40c88d27754f",
        "id": "60f616ab-0309-4ea6-bc12-8cc7f8c44621",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.2.0"
    ...
    "event": {
        "agent_id_status": "verified",
        "created": "2022-07-13T09:45:13.006Z",
        "dataset": "cisco_duo.offline_enrollment",
        "ingested": "2022-07-13T09:45:16Z",
...
```json
{
    "@timestamp": "2022-07-13T09:47:04.343997976Z",
    "agent": {
        "ephemeral_id": "341566d7-02db-46e8-9a07-cb0ef0c19a3d",
        "id": "60f616ab-0309-4ea6-bc12-8cc7f8c44621",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.2.0"
    ...
    "event": {
        "agent_id_status": "verified",
        "created": "2022-07-13T09:47:00.725Z",
        "dataset": "cisco_duo.summary",
        "ingested": "2022-07-13T09:47:04Z",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "95fcabd4-fc63-4550-832c-dad0e9c72307",
        "id": "60f616ab-0309-4ea6-bc12-8cc7f8c44621",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.2.0"
    ...
    "event": {
        "agent_id_status": "verified",
        "created": "2022-07-13T09:48:46.116Z",
        "dataset": "cisco_duo.telephony",
        "ingested": "2022-07-13T09:48:47Z",
        "kind": "event",
