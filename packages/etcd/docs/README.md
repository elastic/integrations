...
| etcd.disk.backend_commit_duration.ns.bucket.\* | Latency for writing backend changes to disk | unsigned_long |
...
| etcd.disk.wal_fsync_duration.ns.bucket.\* | Latency for writing ahead logs to disk | unsigned_long |
