...
An example event for `bigipapm` looks as following:

```json
{
    "@timestamp": "2016-01-29T06:09:59.000Z",
    "agent": {
        "ephemeral_id": "39572803-eb74-4bc3-b6ab-c09c99d8ca57",
...
An example event for `bigipafm` looks as following:

```json
{
    "@timestamp": "2021-12-31T01:41:30.411Z",
    "agent": {
        "ephemeral_id": "feff546d-8044-43c1-a157-389032c53c74",
        "id": "c53ddea2-61ac-4643-8676-0c70ebf51c91",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.0.0-beta1"
    ...
    "event": {
        ...
        "code": "boNemoe",
        "dataset": "f5.bigipafm",
        "ingested": "2021-12-31T01:41:31Z",
        "timezone": "+00:00"
    },
    "host": {
        "ip": "10.228.193.207",
        "name": "tatemac3541.api.corp"
    },
    "input": {
        "type": "udp"
    },
