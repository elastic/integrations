# Microsoft Viva Engage Integration

This integration is for [Microsoft Viva Engage](https://www.microsoft.com/en-in/microsoft-viva/engage).
...
Uses the Microsoft Graph API to retrieve Microsoft Viva Engage Groups Activity. These metrics are from the same reports/dashboards that are available under `Reports` --> `Usage` in the Microsoft 365 Admin Center.

An example event for `groups_activity` looks as following:
...
| m365_viva_engage.groups_activity.group_detail.Group_Display_Name |  | keyword |
| m365_viva_engage.groups_activity.group_detail.Group_Type |  | keyword |
| m365_viva_engage.groups_activity.group_detail.Is_Deleted |  | boolean |
| m365_viva_engage.groups_activity.group_detail.Last_Activity_Date |  | date |
| m365_viva_engage.groups_activity.group_detail.Liked_Count |  | long |
| m365_viva_engage.groups_activity.group_detail.Member_Count |  | long |
| m365_viva_engage.groups_activity.group_detail.Office_365_Connected |  | boolean |
| m365_viva_engage.groups_activity.group_detail.Owner_Principal_Name |  | keyword |
| m365_viva_engage.groups_activity.group_detail.Posted_Count |  | long |
| m365_viva_engage.groups_activity.group_detail.Read_Count |  | long |
| m365_viva_engage.groups_activity.group_detail.Report_Period |  | keyword |
| m365_viva_engage.groups_activity.group_detail.Report_Refresh_Date |  | date |
| m365_viva_engage.groups_activity.metadata.api_path |  | keyword |
| m365_viva_engage.groups_activity.metadata.name |  | keyword |
