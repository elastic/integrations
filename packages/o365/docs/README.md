...
```json
{
    ...
    "agent": {
        "ephemeral_id": "c62de6e3-279a-4b45-a0c1-c5a40fa1e342",
        "id": "8ed6dafa-2942-4d03-aab8-abb603a25df4",
        "name": "elastic-agent-71635",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "client": {
