...
The `firewall` data stream of the Azure Logs package will collect any firewall events that have been streamed through an azure event hub.
...
| azure.firewall.event_category | Event Category | keyword |
...
| azure.firewall.identity.authorization.action | Action | keyword |
| azure.firewall.identity.authorization.evidence.principal_id | Principal ID | keyword |
| azure.firewall.identity.authorization.evidence.principal_type | Principal type | keyword |
| azure.firewall.identity.authorization.evidence.role | Role | keyword |
| azure.firewall.identity.authorization.evidence.role_assignment_id | Role assignment ID | keyword |
| azure.firewall.identity.authorization.evidence.role_assignment_scope | Role assignment scope | keyword |
| azure.firewall.identity.authorization.evidence.role_definition_id | Role definition ID | keyword |
| azure.firewall.identity.authorization.scope | Scope | keyword |
| azure.firewall.identity.claims.\* | Claims | object |
| azure.firewall.identity.claims_initiated_by_user.fullname | Fullname | keyword |
| azure.firewall.identity.claims_initiated_by_user.givenname | Givenname | keyword |
| azure.firewall.identity.claims_initiated_by_user.name | Name | keyword |
| azure.firewall.identity.claims_initiated_by_user.schema | Schema | keyword |
| azure.firewall.identity.claims_initiated_by_user.surname | Surname | keyword |
| azure.firewall.identity_name | identity name | keyword |
| azure.firewall.level | Level | long |
| azure.firewall.operation_name | Operation name | keyword |
| azure.firewall.operation_version | Operation version | keyword |
| azure.firewall.policy | Name of firewall policy containing the matched rule | keyword |
| azure.firewall.properties | Event properties | flattened |
| azure.firewall.result_signature | Result signature | keyword |
| azure.firewall.result_type | Result type | keyword |
| azure.firewall.rule_collection_group | Name of rule collection group containing the matched rule  - name: icmp | keyword |
| azure.firewall.tenant_id | Tenant ID | keyword |
