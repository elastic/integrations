...
| hadoop.cluster.application_main.launch_delay_num_ops | Application Main Launch Delay Operations | long |
| hadoop.cluster.application_main.register_delay_avg_time | Application Main Register Delay Average Time (Milliseconds) | long |
| hadoop.cluster.application_main.register_delay_num_ops | Application Main Register Delay Operations | long |
