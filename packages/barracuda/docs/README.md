...
```json
{
    "@timestamp": "2021-12-24T03:25:44.986Z",
    "agent": {
        "ephemeral_id": "27f09b7e-138f-432a-825c-dc13dd0dcdc7",
    ...
    "rsa": {
        "internal": {
            "event_desc": "PROCMON: Started monitoring",
            "messageid": "PROCMON"
        }
    },
    "tags": [
...
An example event for `spamfirewall` looks as following:

```json
{
    "@timestamp": "2021-12-24T03:21:26.875Z",
    "agent": {
        "ephemeral_id": "23a607de-775d-4d3b-92dc-3faa32fd62f4",
        "id": "82d0dfd8-3946-4ac0-a092-a9146a71e3f7",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.0.0-beta1"
    ...
    "rsa": {
        ...
        "internal": {
            "messageid": "notify/smtp"
        },
        "misc": {
            "action": [
                "accept"
            ],
            "log_session_id": "illumqui",
            "version": "1.2364"
        }
    },
    "source": {
