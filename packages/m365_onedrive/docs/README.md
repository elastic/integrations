...
This integration is for [Microsoft OneDrive](https://www.microsoft.com/en-in/microsoft-365/onedrive).
...
Uses the Microsoft Graph API to retrieve Microsoft OneDrive Usage. These metrics are from the same reports/dashboards that are available under `Reports` --> `Usage` in the Microsoft 365 Admin Center.
...
| m365_onedrive.usage.account_detail.Active_File_Count |  | long |
| m365_onedrive.usage.account_detail.File_Count |  | long |
| m365_onedrive.usage.account_detail.Is_Deleted |  | boolean |
| m365_onedrive.usage.account_detail.Last_Activity_Date |  | date |
| m365_onedrive.usage.account_detail.Owner_Display_Name |  | keyword |
| m365_onedrive.usage.account_detail.Owner_Principal_Name |  | keyword |
| m365_onedrive.usage.account_detail.Report_Period |  | keyword |
| m365_onedrive.usage.account_detail.Report_Refresh_Date |  | date |
| m365_onedrive.usage.account_detail.Site_Id |  | keyword |
| m365_onedrive.usage.account_detail.Site_URL |  | keyword |
| m365_onedrive.usage.account_detail.Storage_Allocated_Byte |  | long |
| m365_onedrive.usage.account_detail.Storage_Used_Byte |  | long |
| m365_onedrive.usage.metadata.api_path |  | keyword |
| m365_onedrive.usage.metadata.name |  | keyword |
