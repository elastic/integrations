...
|---------------------------|----------------------------------------------|--------------|------------------------|------------------|-----------------------|----------------|
| beaconing.pivot_transform | Flags beaconing activity in your environment | `logs-endpoint.events.network-*,logs-network_traffic.*` | ml_beaconing-[version] | ml_beaconing.all | Linux, macOS, Windows | network        |
