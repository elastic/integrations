...
| microsoft_defender_cloud.event.entities.ip_adresses.address |  | ip |
| microsoft_defender_cloud.event.entities.ip_adresses.asset |  | boolean |
| microsoft_defender_cloud.event.entities.ip_adresses.id |  | keyword |
| microsoft_defender_cloud.event.entities.ip_adresses.location.asn |  | long |
| microsoft_defender_cloud.event.entities.ip_adresses.location.city |  | keyword |
| microsoft_defender_cloud.event.entities.ip_adresses.location.country_code |  | keyword |
| microsoft_defender_cloud.event.entities.ip_adresses.location.country_name |  | keyword |
| microsoft_defender_cloud.event.entities.ip_adresses.location.latitude |  | double |
| microsoft_defender_cloud.event.entities.ip_adresses.location.longitude |  | double |
| microsoft_defender_cloud.event.entities.ip_adresses.location.state |  | keyword |
| microsoft_defender_cloud.event.entities.ip_adresses.type |  | keyword |
