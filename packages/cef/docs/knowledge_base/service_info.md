...
2. Configure the following fields:
   ...
   - **Pre-Processors**: Pre-processors are run before the CEF message is decoded. They can be used to correct CEF formatting inconsistencies that might exist from some sources. See [Processors](https://www.elastic.co/guide/en/beats/filebeat/current/filtering-and-enhancing-data.html) for details.
