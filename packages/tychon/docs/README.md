...
```json
{
    ...
    "script.start": "2023-11-01T18:01:51Z",
    "destination.mac": [
        "04-d5-90-f6-de-a3"
    ],
    ...
    "network.type": "IPv4",
    "host.oem.model": "",
    "host.uptime": "603361.260258",
    "id": "BOTANYBAYEP1#11#10.1.9.51#10.1.9.1",
    "script.current_time": "2023-11-01T18:02:07Z",
    "script.name": "Get-TychonArpInfo.ps1",
    "network.state": "dynamic",
    "script.version": "2.3.152.0",
    "host.os.build": "19045",
    "host.os.description": "",
    "script.current_duration": "15988.70",
    "host.ipv6": "",
    "destination.ip": "10.1.9.1",
