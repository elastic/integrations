...
```json
{
    "@timestamp": "2024-01-23T10:45:55.097Z",
    "agent": {
        "ephemeral_id": "3cfe9445-1fa6-4c4c-8e55-a040a1b32916",
        "id": "87240921-8cf0-459c-b6df-e12258b33f3a",
    ...
    "aws": {
        "s3": {
            "bucket": {
                "arn": "arn:aws:s3:::elastic-package-imperva-cloud-waf-bucket-86089",
                "name": "elastic-package-imperva-cloud-waf-bucket-86089"
            },
            "object": {
                "key": "events.log"
            }
    ...
    "log": {
        "file": {
            "path": "https://elastic-package-imperva-cloud-waf-bucket-86089.s3.us-east-1.amazonaws.com/events.log"
        },
        "offset": 134
    },
    "message": "Normal",
