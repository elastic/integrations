...
*/}}
# Defend for Containers OTEL input package (BETA) Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and the service it integrates with. */}}
The Defend for Containers OTEL input package (BETA) integration for Elastic enables collection of ...
...
*/}}
The Defend for Containers OTEL input package (BETA) integration collects log messages of the following types:
* ...
...
### Set up steps in Defend for Containers OTEL input package (BETA)
