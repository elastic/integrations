...
> **Note:** Elastic Managed deployment is currently supported for Microsoft Foundry metrics only. Log collection is not available via Elastic Managed and requires a traditional Elastic Agent deployment.
