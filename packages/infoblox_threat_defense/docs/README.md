...
```json
{
    ...
    "agent": {
        "ephemeral_id": "a2950830-e9e9-49be-932a-cf58c32a4853",
        "id": "d13c5c78-7b83-405a-96cd-29215bd5575f",
        "name": "elastic-agent-11894",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "data_stream": {
