...
- `mongod_audit`: This data stream collects a detailed record of database operations such as insertions, updates, deletions, user authentication, etc. It allows administrators and users to track activities in systems with multiple users and applications, focusing on database operations within mongod instances.
...
- `organization`: This data stream collects a comprehensive log of your organization's activities, focusing on key events and changes related to database operations, billing, security, hosts, encryption, user access, and more. It helps in tracking and monitoring actions performed by users and teams.
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "2dc0c503-3a56-4be5-a0e8-f9ce534ca063",
        "id": "24df3cda-ab3e-4eaf-80a3-73dd95293cc7",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.13.0"
    },
...
| mongodb_atlas.organization.target_user.email | Email address for the console user that this event targets. | keyword |
...
| mongodb_atlas.project.metric.value | Value of the metric. | double |
...
```json
{
    "@timestamp": "2024-07-31T06:14:58.162Z",
    "agent": {
        "ephemeral_id": "a00d7fe8-cf4b-4ed1-840a-b5b06c94671c",
        "id": "b8e3f358-ac74-4aa2-956d-65285a139d65",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.13.0"
    },
...
```json
{
    "@timestamp": "2024-07-31T06:11:01.689Z",
    "agent": {
        "ephemeral_id": "a00d7fe8-cf4b-4ed1-840a-b5b06c94671c",
        "id": "b8e3f358-ac74-4aa2-956d-65285a139d65",
        "name": "docker-fleet-agent",
