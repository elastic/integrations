...
Data streams:
- `alert`: Collects alerts generated by MongoDB Atlas instance. Alerts cover a wide range of metrics and events, such as last notification time, processor information, replica set names, alert resolution times, source types, alert statuses, tags, update times, and user aliases.
...
The `alert` data stream collects alerts generated by the MongoDB Atlas. Alerts cover a wide range of logs and events, such as last notification time, processor information, replica set names, alert resolution times, source types, alert statuses, tags, update times, and user aliases. To collect alert logs, the requesting API Key must have the `Project Read Only` role.
