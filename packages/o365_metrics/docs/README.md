...
| o365.metrics.viva_engage.groups_activity.group_detail.report_period |  | keyword |
| o365.metrics.viva_engage.groups_activity.group_detail.report_refresh_date |  | date |
