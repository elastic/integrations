...
| o365.metrics.onedrive.usage.account.counts.site_type | The type of OneDrive sites included in the report (e.g., All, Team, Personal). | keyword |
...
| o365.metrics.onedrive.usage.file.counts.site_type | The type of OneDrive sites included in the report (e.g., All, Team, Personal). | keyword |
...
| o365.metrics.onedrive.usage.storage.site_type | The type of OneDrive sites included in the report (e.g., All, Team, Personal). | keyword |
