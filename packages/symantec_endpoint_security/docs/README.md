...
```json
{
    ...
    "agent": {
        "ephemeral_id": "75140a75-8187-43dd-ab8e-a5913552125e",
        "id": "47c6af15-e32a-45f2-822b-9c41f7482560",
        "name": "elastic-agent-67776",
        "type": "filebeat",
        "version": "8.16.5"
    },
    "azure": {
    ...
    "log": {
        "file": {
            "path": "http://svc-azure-blob-storage-emulator:10000/devstoreaccount1/test-container/test-events.log"
        },
        "level": [
            "Log Level"
        ],
...
| aws.s3.bucket |  | flattened |
| aws.s3.object |  | flattened |
| azure.resource |  | flattened |
| azure.storage |  | flattened |
