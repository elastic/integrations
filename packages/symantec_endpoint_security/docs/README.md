...
```json
{
    ...
    "agent": {
        "ephemeral_id": "2979533b-cdb6-49c0-8665-3223e6922f90",
        "id": "68d148de-0c02-47af-b9dd-210b7682ece0",
        "name": "elastic-agent-86709",
        "type": "filebeat",
        "version": "8.16.5"
    },
    "client": {
    ...
    "log": {
        "file": {
            "path": "gs://testbucket/test-events.log"
        },
        "level": [
            "Log Level"
        ],
