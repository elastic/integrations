...
*/}}
# System OpenTelemetry Input Package Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The System OpenTelemetry Input Package integration for Elastic enables collection of ...
...
The System OpenTelemetry Input Package integration collects log messages of the following types:
* ...
