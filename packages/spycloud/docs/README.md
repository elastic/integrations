...
```json
{
    ...
    "agent": {
        "ephemeral_id": "90dc28d2-8a37-4b01-b145-4ee5f9207fcf",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "cd4912d6-0935-4cbf-ae4b-8e9fbac4dbad",
        "id": "401b5614-f720-4272-afd1-fdd38e876355",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.13.0"
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "6fe389c2-f840-4526-a13c-8721be3d71b4",
        "id": "401b5614-f720-4272-afd1-fdd38e876355",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.13.0"
