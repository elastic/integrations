...
| haproxy.metrics.haproxy_backend_downtime_seconds_total | Total time spent in DOWN state, for server or backend | long | counter |
...
| haproxy.metrics.haproxy_frontend_bytes_in_total | Total number of request bytes since process started. Label: proxy=frontend name. | long | counter |
| haproxy.metrics.haproxy_frontend_bytes_out_total | Total number of response bytes since process started. Label: proxy=frontend name. | long | counter |
...
| haproxy.metrics.haproxy_listener_bytes_in_total | Total number of request bytes since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_bytes_out_total | Total number of response bytes since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_current_sessions | Number of current sessions on the frontend, backend or server. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | double | gauge |
| haproxy.metrics.haproxy_listener_denied_connections_total | Total number of incoming connections blocked on a listener/frontend by a tcp-request connection rule since the worker process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_denied_sessions_total | Total number of incoming sessions blocked on a listener/frontend by a tcp-request connection rule since the worker process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_failed_header_rewriting_to | Total number of failed HTTP header rewrites since the worker process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_internal_errors_total | Total number of internal errors since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_limit_sessions | Frontend/listener/server’s maxconn, backend’s fullconn. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | double | gauge |
| haproxy.metrics.haproxy_listener_max_sessions | Highest value of current sessions encountered since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | double | gauge |
| haproxy.metrics.haproxy_listener_request_errors_total | Total number of invalid requests since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_requests_denied_total | Total number of denied requests since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_responses_denied_total | Total number of denied responses since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_sessions_total | Total number of sessions since process started. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_ssl_failed_handshake | Total number of failed handshake. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_ssl_reused_sess | Total number of ssl sessions reused. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_ssl_sess | Total number of ssl sessions established. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name. | long | counter |
| haproxy.metrics.haproxy_listener_status | Current status of the service. One metric for each combination of service and status. To enable, add option socket-stats to your Prometheus frontend in the load balancer configuration. Labels: proxy=listener or frontend name, listener=bind name, state=service state. | double | gauge |
