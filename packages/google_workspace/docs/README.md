...
```json
{
    ...
    "agent": {
        "ephemeral_id": "bd2a0047-3e89-4390-83a9-05d25b51f0af",
        "id": "3955c167-c2de-4a5d-a4c5-2a6338f14976",
        "name": "elastic-agent-28992",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T05:14:30.997Z",
        "dataset": "google_workspace.saml",
        "id": "1",
        "ingested": "2025-12-08T05:14:33Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "2584ee05-3825-4d30-aa4a-f5cb5079a86b",
        "id": "b7fad8f9-bc41-411b-bffe-af86756ad274",
        "name": "elastic-agent-20157",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T05:17:05.124Z",
        "dataset": "google_workspace.user_accounts",
        "id": "1",
        "ingested": "2025-12-08T05:17:08Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "e4048d3d-afb8-4c10-adc4-95dcd300b19e",
        "id": "80a855c8-f052-4ef6-b0ca-053ae021cfa2",
        "name": "elastic-agent-55461",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2026-07-29T04:12:29.868Z",
        "dataset": "google_workspace.login",
        "id": "1",
        "ingested": "2026-07-29T04:12:32Z",
        "kind": "event",
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "f9501162-cab7-43e1-b483-818df864526f",
        "id": "c3f09287-dd43-4314-8bf2-169c1e558717",
        "name": "elastic-agent-92827",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2026-07-29T04:13:30.176Z",
        "dataset": "google_workspace.rules",
        "id": "1",
        "ingested": "2026-07-29T04:13:33Z",
        "kind": "alert",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "be759c1f-b7df-401c-a439-301ce669e1cf",
        "id": "7bbc0968-e2bd-4ea0-9ad6-0d1905db8cc0",
        "name": "elastic-agent-22757",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T04:30:23.548Z",
        "dataset": "google_workspace.admin",
        "id": "1",
        "ingested": "2025-12-08T04:30:26Z",
        "kind": "event",
...
```json
{
    "@timestamp": "2022-05-04T15:04:05.000Z",
    "agent": {
        "ephemeral_id": "adf02247-dcaf-4bf6-9ec8-20f39a74d728",
        "id": "6e518c72-e44d-4d00-9c53-ff9a1193bdfd",
        "name": "elastic-agent-22865",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T04:35:12.992Z",
        "dataset": "google_workspace.drive",
        "id": "1",
        "ingested": "2025-12-08T04:35:15Z",
        "kind": "event",
...
```json
{
    "@timestamp": "2022-05-04T15:04:05.000Z",
    "agent": {
        "ephemeral_id": "36d67a37-e085-4f66-919c-062e051e3b89",
        "id": "6f70996c-b0bd-44a8-adb2-3830bda3945c",
        "name": "elastic-agent-11905",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T04:40:03.193Z",
        "dataset": "google_workspace.groups",
        "id": "1",
        "ingested": "2025-12-08T04:40:06Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "e52a3dcd-cf85-4324-a66a-6525ae8abd72",
        "id": "aba87649-9561-497c-92d7-4d386a9b472a",
        "name": "elastic-agent-24009",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "cf7859d2-bcd3-4e91-9434-5af0f3d3f6bc",
        "id": "af766712-5402-4b83-931f-6d151f49defa",
        "name": "elastic-agent-99347",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2026-07-29T04:10:28.571Z",
        "dataset": "google_workspace.device",
        "id": "1",
        "ingested": "2026-07-29T04:10:31Z",
        "kind": "event",
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "e3f81d0d-57f7-4597-98e1-a27a45dbaa60",
        "id": "a57d3ab2-14fb-4207-b547-3353fbc53323",
        "name": "elastic-agent-87330",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-12-08T05:15:55.348Z",
        "dataset": "google_workspace.token",
        "id": "1",
        "ingested": "2025-12-08T05:15:58Z",
        "kind": [
            "event"
        ],
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "b5224f0a-b775-4fd3-b708-360f265f6c72",
        "id": "20e7e144-e83e-440c-84fb-80d2dc4e9789",
        "name": "elastic-agent-81103",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        "action": "APPLICATION_EVENT",
        "agent_id_status": "verified",
        "created": "2025-12-08T04:22:56.428Z",
        "dataset": "google_workspace.access_transparency",
        "id": "1",
        "ingested": "2025-12-08T04:22:59Z",
        "kind": [
            "event"
        ],
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "3a36557f-f0d1-4a59-8361-19a8609a8d7a",
        "id": "65ce985f-497e-456d-b6d8-e0c0f3864a08",
        "name": "elastic-agent-64228",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        "action": "APPLICATION_EVENT",
        "agent_id_status": "verified",
        "created": "2026-07-22T06:56:35.154Z",
        "dataset": "google_workspace.context_aware_access",
        "id": "1",
        "ingested": "2026-07-22T06:56:38Z",
        "kind": "event",
...
```json
{
    "@timestamp": "2020-10-02T15:00:00.000Z",
    "agent": {
        "ephemeral_id": "e462c95e-fc7b-4e8c-8e17-c078bbd6363a",
        "id": "3be6ee34-e840-4202-a088-f8cbacd473b4",
        "name": "elastic-agent-95567",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2026-07-22T06:59:03.390Z",
        "dataset": "google_workspace.gcp",
        "id": "1",
        "ingested": "2026-07-22T06:59:06Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "badc7085-7c02-4c86-b76e-394e9ca1d669",
        "id": "e361e869-51a3-4e11-9525-c96595319143",
        "name": "elastic-agent-34701",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "833853f9-febd-4424-916d-902130ddaf9e",
        "id": "c5aebc7f-a471-46b7-82c5-b172b336f7da",
        "name": "elastic-agent-84379",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "63e3d48f-55f0-4329-97a7-ccb77d539f2a",
        "id": "8f3a240d-a025-4cfc-a3d2-0569d269a1fe",
        "name": "elastic-agent-60488",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "f655fbf2-623b-4948-a638-c1ccd743a3ef",
        "id": "1be3bd34-3d99-4e8a-bcda-4ee31f491bd4",
        "name": "elastic-agent-79178",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "71d11372-1a72-49b3-a1a6-37b19a3f7851",
        "id": "722fe293-8487-43c7-bb6e-df12f5f19e44",
        "name": "elastic-agent-18911",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "a1dc4da9-10b6-4671-b3d9-20f0c9558c3f",
        "id": "a1731c07-db09-45af-aa19-cd51604e7136",
        "name": "elastic-agent-87212",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
