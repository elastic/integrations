...
| google_workspace.gmail_reports.event_type |  | keyword |
| google_workspace.gmail_reports.has_sensitive_content |  | boolean |
...
| google_workspace.gmail_reports.message_info.connection_info.dmarc_published_domain |  | keyword |
...
| google_workspace.gmail_reports.message_info.connection_info.spf_pass | Indicates if the message was authenticated with SP. | boolean |
...
| google_workspace.gmail_reports.resource_details.application_id |  | keyword |
...
| google_workspace.gmail_reports.resource_details.relation |  | keyword |
