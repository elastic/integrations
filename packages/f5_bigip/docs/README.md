...
| f5_bigip.log.asm_attack_signatures.\*.name |  | object |
...
| f5_bigip.log.connections_performance.\*.name |  | object |
...
| f5_bigip.log.disk_latency.\*.name |  | object |
...
| f5_bigip.log.disk_storage.\*.capacity |  | object |
| f5_bigip.log.disk_storage.\*.capacity_float |  | object |
| f5_bigip.log.disk_storage.\*.name |  | object |
...
| f5_bigip.log.provisioning.\*.level |  | object |
| f5_bigip.log.provisioning.\*.name |  | object |
...
| f5_bigip.log.throughput_performance.\*.name |  | object |
