...
```json
{
    ...
    "agent": {
        "ephemeral_id": "3f1d7be3-307a-4443-8a13-4715164f6b93",
        "id": "e23ece8b-b9e3-4555-99ec-740b686c7d46",
        "name": "elastic-agent-12734",
        "type": "filebeat",
        "version": "8.19.0"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "tenable_io.vulnerability.indexed",
        "dataset": "tenable_io.vulnerability",
        "ingested": "2025-04-25T13:36:00Z",
        "kind": "state",
    ...
    "tenable_io": {
        "vulnerability": {
            ...
            "output": "Path              : /opt/jdk-11.0.2/||Installed version : 11.0.2||Fixed version     : Upgrade to a version greater than 11.0.18;;Path              : /usr/java/jdk1.8.0_232-cloudera/||Installed version : 8.0.232||Fixed version     : Upgrade to a version greater than 8u362||",
            "plugin": {
                "cve": [
                    "CVE-2016-1620",
                    "CVE-2016-1614",
