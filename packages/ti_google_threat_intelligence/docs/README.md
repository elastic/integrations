...
```json
{
    ...
    "agent": {
        "ephemeral_id": "1a58e4aa-1095-49ac-b2e9-f9e9d27ae127",
        "id": "1396da7b-f5a3-4054-9e7c-80b789c97b80",
        "name": "elastic-agent-13111",
        "type": "filebeat",
        "version": "8.16.0"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2026-07-19T03:45:16.000Z",
        "dataset": "ti_google_threat_intelligence.vulnerability",
        "ingested": "2026-07-28T15:37:35Z",
        "kind": "enrichment",
        "original": "{\"attributes\":{\"aggregations\":{},\"alt_names\":[],\"alt_names_details\":[],\"autogenerated_tags\":[],\"available_mitigation\":[],\"capabilities\":[],\"collection_links\":[],\"collection_type\":\"vulnerability\",\"counters\":{\"attack_techniques\":0,\"domains\":0,\"files\":0,\"iocs\":0,\"ip_addresses\":0,\"subscribers\":0,\"urls\":0},\"cpes\":[{\"end_cpe\":null,\"end_rel\":null,\"start_cpe\":{\"product\":\"django-tastypie\",\"uri\":\"cpe:2.3:a:django-tastypie:django-tastypie:0.15.1:*:*:*:*:*:*:*\",\"vendor\":\"Django-Tastypie\",\"version\":\"0.15.1\"},\"start_rel\":\"=\"}],\"creation_date\":1784432716,\"cve_id\":\"CVE-2026-16208\",\"cvss\":{\"cvssv2_0\":{\"base_score\":4.6,\"temporal_score\":4.4,\"vector\":\"AV:N/AC:H/Au:S/C:P/I:P/A:P/E:ND/RL:ND/RC:UR\"},\"cvssv3_x\":{\"base_score\":5,\"temporal_score\":4.8,\"vector\":\"CVSS:3.0/AV:N/AC:H/PR:L/UI:N/S:U/C:L/I:L/A:L/E:X/RL:X/RC:R\"},\"cvssv3_x_translated\":{\"base_score\":5,\"temporal_score\":5,\"vector\":\"CVSS:3.1/AV:N/AC:H/PR:L/UI:N/S:U/C:L/I:L/A:L\"},\"cvssv4_x\":{\"score\":0.6,\"supplemental\":{\"automatable\":null,\"provider_urgency\":null,\"recovery\":null,\"response_effort\":null,\"safety\":null,\"value_density\":null},\"threat\":{\"exploit_maturity\":\"Unreported\"},\"vector\":\"CVSS:4.0/AV:N/AC:H/AT:N/PR:L/UI:N/VC:L/SC:N/VI:L/SI:N/VA:L/SA:N/E:U\"}},\"cwe\":{\"id\":\"CWE-362\",\"title\":\"Concurrent Execution using Shared Resource with Improper Synchronization ('Race Condition')\"},\"date_of_disclosure\":1781308800,\"days_to_report\":36,\"description\":\"Mitre Corporation has provided the following description:   \\n*A flaw has been found in django-tastypie up to 0.15.1. The affected element is the function CacheThrottle/CacheDBThrottle of the file tastypie/throttle.py. This manipulation causes race condition. The attack may be initiated remotely. The complexity of an attack is rather high. The exploitability is described as difficult. The project was informed of the problem early through an issue report but has not responded yet.*\",\"detection_names\":[],\"domains_count\":0,\"epss\":{\"percentile\":0.06314,\"score\":0.00167},\"executive_summary\":\"* A Concurrent Execution using Shared Resource with Improper Synchronization ('Race Condition') vulnerability exists that, when exploited, allows a remote, privileged attacker to bypass certain security mechanisms.\\n* We are currently unaware of exploitation activity in the wild. Exploit code is not publicly available.\\n* Google Threat Intelligence Group (GTIG) considers this a Low-risk vulnerability due to the potential for bypassing certain security mechanisms.\\n* There are currently no mitigation options available for this issue.\",\"exploit_availability\":\"No Known\",\"exploitation\":{\"exploit_release_date\":null,\"first_exploitation\":null,\"tech_details_release_date\":null},\"exploitation_consequence\":\"Security Bypass\",\"exploitation_state\":\"No Known\",\"exploitation_vectors\":[\"Unspecified Remote Vector\"],\"field_sources\":[{\"field\":\"cvss.cvssv4_x.vector\",\"source\":{\"field_type\":\"Ranked\",\"source_name\":\"Mitre Corporation\",\"source_url\":\"\",\"sources\":[]}}],\"files_count\":0,\"first_seen_details\":[],\"ip_addresses_count\":0,\"last_modification_date\":1784552499,\"last_seen_details\":[],\"malware_roles\":[],\"mati_genids_dict\":{\"cve_id\":\"vulnerability--1a2b2ac9-37f4-5819-8f9c-148a7b749160\",\"mve_id\":\"vulnerability--a44a3735-4900-59bb-8d2a-1e7ed252645a\",\"report_id\":null},\"merged_actors\":[],\"motivations\":[],\"mve_id\":\"MVE-2026-43175\",\"name\":\"CVE-2026-16208\",\"operating_systems\":[],\"origin\":\"Google Threat Intelligence\",\"predicted_risk_rating\":\"LOW\",\"priority\":\"P4\",\"private\":false,\"recent_activity_summary\":[0],\"references_count\":0,\"risk_factors\":[],\"risk_rating\":\"\",\"source_regions_hierarchy\":[],\"sources\":[{\"cvss\":{\"cvssv2_0\":{\"base_score\":4.6,\"temporal_score\":null,\"vector\":\"AV:N/AC:H/Au:S/C:P/I:P/A:P/E:ND/RL:ND/RC:UR\"},\"cvssv3_x\":{\"base_score\":5,\"temporal_score\":null,\"vector\":\"CVSS:3.0/AV:N/AC:H/PR:L/UI:N/S:U/C:L/I:L/A:L/E:X/RL:X/RC:R\"},\"cvssv3_x_translated\":null,\"cvssv4_x\":{\"score\":2.3,\"supplemental\":null,\"threat\":null,\"vector\":\"CVSS:4.0/AV:N/AC:H/AT:N/PR:L/UI:N/VC:L/SC:N/VI:L/SI:N/VA:L/SA:N/E:X\"}},\"md5\":\"9844ea23780fe03575de0363fabaa40d\",\"name\":\"Mitre Corporation\",\"published_date\":1784429109,\"source_description\":null,\"title\":\"django-tastypie throttle.py CacheDBThrottle race condition\",\"unique_id\":\"VDB-380024\",\"url\":\"https://github.com/CVEProject/cvelistV5/blob/main/cves/2026/16xxx/CVE-2026-16208.json\"}],\"status\":\"COMPUTED\",\"subscribers_count\":0,\"tags\":[],\"tags_details\":[],\"targeted_industries\":[],\"targeted_industries_tree\":[],\"targeted_regions\":[],\"targeted_regions_hierarchy\":[],\"top_icon_md5\":[],\"urls_count\":0,\"vendor_fix_references\":[],\"version_history\":[{\"date\":1784552499,\"version_notes\":[\"cpes: Added\"]}],\"workarounds\":[]},\"context_attributes\":{\"role\":\"viewer\",\"shared_with_me\":false},\"id\":\"vulnerability--cve-2026-16208\",\"links\":{\"self\":\"https://www.virustotal.com/api/v3/collections/vulnerability--cve-2026-16208\"},\"type\":\"collection\"}",
        "type": [
            "info"
        ],
        "url": "https://www.virustotal.com/api/v3/collections/vulnerability--cve-2026-16208"
    },
    "gti": {
        "vulnerability": {
            "attributes": {
                ...
                "cpes": [
                    {
                        "start_cpe": {
                            ...
                            "uri": "cpe:2.3:a:django-tastypie:django-tastypie:0.15.1:*:*:*:*:*:*:*",
                            "vendor": "Django-Tastypie",
                            "version": "0.15.1"
                        },
                        "start_rel": "="
                    }
                ],
                "creation_date": "2026-07-19T03:45:16.000Z",
                ...
                "cvss": {
                    ...
                    "cvssv4_x": {
                        ...
                        "vector": "CVSS:4.0/AV:N/AC:H/AT:N/PR:L/UI:N/VC:L/SC:N/VI:L/SI:N/VA:L/SA:N/E:U"
                    }
                },
                "cwe": {
                    "id": "CWE-362",
                ...
                "executive_summary": "* A Concurrent Execution using Shared Resource with Improper Synchronization ('Race Condition') vulnerability exists that, when exploited, allows a remote, privileged attacker to bypass certain security mechanisms.\n* We are currently unaware of exploitation activity in the wild. Exploit code is not publicly available.\n* Google Threat Intelligence Group (GTIG) considers this a Low-risk vulnerability due to the potential for bypassing certain security mechanisms.\n* There are currently no mitigation options available for this issue.",
                ...
                "mati_genids_dict": {
                    "cve_id": "vulnerability--1a2b2ac9-37f4-5819-8f9c-148a7b749160",
                    "mve_id": "vulnerability--a44a3735-4900-59bb-8d2a-1e7ed252645a"
                },
                "mve_id": "MVE-2026-43175",
                "name": "CVE-2026-16208",
                "origin": "Google Threat Intelligence",
                "predicted_risk_rating": "LOW",
                "priority": "P4",
                ...
                "sources": [
                    {
                        "cvss": {
                            ...
                            "cvssv4_x": {
                                "score": 2.3,
                                "vector": "CVSS:4.0/AV:N/AC:H/AT:N/PR:L/UI:N/VC:L/SC:N/VI:L/SI:N/VA:L/SA:N/E:X"
                            }
                        },
                        "md5": "9844ea23780fe03575de0363fabaa40d",
                        "name": "Mitre Corporation",
                        "published_date": "2026-07-19T02:45:09.000Z",
                        "title": "django-tastypie throttle.py CacheDBThrottle race condition",
                        "unique_id": "VDB-380024",
                        "url": "https://github.com/CVEProject/cvelistV5/blob/main/cves/2026/16xxx/CVE-2026-16208.json"
                    }
                ],
                "status": "COMPUTED",
                "subscribers_count": 0,
            ...
            "id": "vulnerability--cve-2026-16208",
            "links": {
                "self": "https://www.virustotal.com/api/v3/collections/vulnerability--cve-2026-16208"
            },
            "type": "collection"
        }
    },
    ...
    "vulnerability": {
        ...
        "description": "Mitre Corporation has provided the following description:   \n*A flaw has been found in django-tastypie up to 0.15.1. The affected element is the function CacheThrottle/CacheDBThrottle of the file tastypie/throttle.py. This manipulation causes race condition. The attack may be initiated remotely. The complexity of an attack is rather high. The exploitability is described as difficult. The project was informed of the problem early through an issue report but has not responded yet.*",
        "id": "CVE-2026-16208",
        "reference": "https://www.virustotal.com/api/v3/collections/vulnerability--cve-2026-16208",
        "scanner": {
            "vendor": "Google"
        },
        "score": {
...
| gti.vulnerability.attributes.autogenerated_tags | list of available ways to reduce / mitigate the vulnerability. | keyword |
...
| gti.vulnerability.attributes.date_of_disclosure | vulnerability disclosure date (UTC timestamp). | long |
...
| gti.vulnerability.attributes.exploitation.first_exploitation | earliest known exploitation date (UTC timestamp). | long |
...
| gti.vulnerability.attributes.first_seen_details.value | date when the first observation about that vulnerability was made ("YYYY-MM-DDTHH:mm:ssZ" format). | keyword |
...
| gti.vulnerability.attributes.last_seen_details.value | date when the last observation about that vulnerability was made ("YYYY-MM-DDTHH:mm:ssZ" format). | keyword |
