...
```json
{
    ...
    "agent": {
        "ephemeral_id": "37a345ac-4275-47d3-8fa8-095006019f7f",
        "id": "6572009c-0097-4eca-b339-4d371ec077ca",
        "name": "elastic-agent-27358",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "aws": {
        "s3": {
            "bucket": {
                "arn": "arn:aws:s3:::elastic-package-beyondtrust-epm-bucket-32103",
                "name": "elastic-package-beyondtrust-epm-bucket-32103"
            },
            "object": {
                "key": "event.log"
            }
