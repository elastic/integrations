...
```json
{
    ...
    "agent": {
        "ephemeral_id": "46c6087a-a0e1-4727-8720-170ee3ac9aa0",
        "id": "127c692e-cddd-4126-8453-8a3ad11cd184",
        "name": "elastic-agent-86103",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "aws": {
        "s3": {
            "bucket": {
                "arn": "arn:aws:s3:::elastic-package-beyondtrust-epm-bucket-21342",
                "name": "elastic-package-beyondtrust-epm-bucket-21342"
            },
            "object": {
                "key": "audit.log"
            }
    ...
    "beyondtrust_epm": {
        "audit": {
            ...
            "details": "User john.doe modified security policy settings for Windows Defender Exclusions",
            ...
            "user_id": "a7b5c3d1-8f2e-4a6b-9c3d-e5f7a2b4c6d8"
        }
    },
    "cloud": {
        "region": "us-east-1"
    ...
    "log": {
        "file": {
            "path": "https://elastic-package-beyondtrust-epm-bucket-21342.s3.us-east-1.amazonaws.com/audit.log"
        },
        "offset": 0
    },
