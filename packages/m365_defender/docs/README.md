...
```json
{
    ...
    "agent": {
        "ephemeral_id": "d1195c8a-2463-47cf-b05d-243887fe19b0",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "6b34e249-d345-447f-9dd1-322ee6bef39d",
        "id": "f7070b0b-fbce-4ea8-a8b4-9591ca3f2b72",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.6.0"
