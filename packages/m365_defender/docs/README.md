...
```json
{
    "@timestamp": "2021-05-02T14:19:01.326Z",
    "agent": {
        "ephemeral_id": "cd130691-21a9-4869-a37d-e6625ada74bb",
        "hostname": "docker-fleet-agent",
        "id": "08675f56-74b4-46fe-b3e6-7daedb1031cb",
    ...
    "m365_defender": {
        "alert": {
            ...
            "odata_type": "#microsoft.graph.security.alert",
    ...
    "message": "A hidden file has been launched. This activity could indicate a compromised host. Attackers often hide files associated with malicious tools to evade file system inspection and defenses.",
    "process": {
        "command_line": [
            "\"MsSense.exe\""
        ],
...
| m365_defender.alert.comments.created_by_display_name | The person or app name that submitted the comment. | keyword |
| m365_defender.alert.comments.created_datetime | The time when the comment was submitted. | date |
| m365_defender.alert.comments.message | The comment text. | keyword |
| m365_defender.alert.comments.odata_type |  | keyword |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "22f48a37-89c7-4127-9540-c81abe3c9c7a",
        "hostname": "docker-fleet-agent",
        "id": "08675f56-74b4-46fe-b3e6-7daedb1031cb",
        "name": "docker-fleet-agent",
        "type": "filebeat",
    ...
    "m365_defender": {
        "incident": {
            ...
            "comments": [
                {
                    "created_by": "DavidS@contoso.onmicrosoft.com",
                    "created_time": "2021-09-30T12:07:37.275Z",
...
| m365_defender.incident.alert.comments.created_by_display_name | The person or app name that submitted the comment. | keyword |
| m365_defender.incident.alert.comments.created_datetime | The time when the comment was submitted. | date |
| m365_defender.incident.alert.comments.message | The comment text. | keyword |
| m365_defender.incident.alert.comments.odata_type |  | keyword |
...
| m365_defender.incident.comments.created_by | The person or app name that submitted the comment. | keyword |
| m365_defender.incident.comments.created_by_display_name | The person or app name that submitted the comment. | keyword |
| m365_defender.incident.comments.created_datetime | The time when the comment was submitted. | date |
| m365_defender.incident.comments.created_time | The time when the comment was submitted. | date |
| m365_defender.incident.comments.message | The comment text. | keyword |
| m365_defender.incident.comments.odata_type |  | keyword |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "e1223324-b679-4106-9d96-877a65590aeb",
        "hostname": "docker-fleet-agent",
        "id": "08675f56-74b4-46fe-b3e6-7daedb1031cb",
        "name": "docker-fleet-agent",
        "type": "filebeat",
