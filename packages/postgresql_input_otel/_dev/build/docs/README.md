...
*/}}
# PostgreSQL OpenTelemetry Input Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The PostgreSQL OpenTelemetry Input integration for Elastic enables collection of ...
...
The PostgreSQL OpenTelemetry Input integration collects log messages of the following types:
* ...
