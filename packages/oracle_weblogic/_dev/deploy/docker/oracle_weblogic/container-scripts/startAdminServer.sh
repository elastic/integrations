...
JAVA_OPTIONS="-javaagent:/home/oracle/jolokia-jvm-1.6.0-agent.jar=port=8005,host=0.0.0.0 -Djavax.management.builder.initial=weblogic.management.jmx.mbeanserver.WLSMBeanServerBuilder"
