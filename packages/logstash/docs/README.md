...
| logstash_state.pipeline.hash |  | alias |
| logstash_state.pipeline.id |  | alias |
| logstash_stats.events.duration_in_millis |  | alias |
| logstash_stats.events.in |  | alias |
| logstash_stats.events.out |  | alias |
| logstash_stats.jvm.mem.heap_max_in_bytes |  | alias |
| logstash_stats.jvm.mem.heap_used_in_bytes |  | alias |
| logstash_stats.jvm.uptime_in_millis |  | alias |
| logstash_stats.logstash.uuid |  | alias |
| logstash_stats.logstash.version |  | alias |
| logstash_stats.os.cgroup.cpuacct.usage_nanos |  | alias |
| logstash_stats.os.cpu.load_average.15m |  | alias |
| logstash_stats.os.cpu.load_average.1m |  | alias |
| logstash_stats.os.cpu.load_average.5m |  | alias |
| logstash_stats.os.cpu.stat.number_of_elapsed_periods |  | alias |
| logstash_stats.os.cpu.stat.number_of_times_throttled |  | alias |
| logstash_stats.os.cpu.stat.time_throttled_nanos |  | alias |
| logstash_stats.pipelines |  | nested |
| logstash_stats.process.cpu.percent |  | alias |
| logstash_stats.queue.events_count |  | alias |
