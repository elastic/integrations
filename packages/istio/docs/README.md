...
| istio.istiod.metrics.\*.counter | Istiod counter metric | double | counter |
| istio.istiod.metrics.\*.histogram | Istiod histogram metric | object |  |
| istio.istiod.metrics.\*.rate | Istiod rated counter metric | double | gauge |
| istio.istiod.metrics.\*.value | Istiod gauge metric | double | gauge |
