...
| adminbyrequest.auditlog.denied_reason | Reason for denying the request supplied by an administrator | text |
...
| adminbyrequest.auditlog.user.full_name | The full name of the user | keyword |
...
|---|---|---|
| @timestamp | Event timestamp. | date |
| adminbyrequest.events.additional_data | Additional data can for example be the version of the Admin By Request install/uninstall event or the tampered registry key | text |
| adminbyrequest.events.alert_account | A secondary account. For example the account added to the local administrators account by the "userAccount" user | keyword |
| adminbyrequest.events.application.file | The file name of the file executed using Run As Admin | keyword |
| adminbyrequest.events.application.name | The name of the application (description property of file) | keyword |
| adminbyrequest.events.application.path | The file path of the executed application | keyword |
| adminbyrequest.events.application.sha256 | The checksum of the file | keyword |
| adminbyrequest.events.application.vendor | The vendor of the application | keyword |
| adminbyrequest.events.application.version | The version of the file | keyword |
| adminbyrequest.events.audit_log_url | URL to the auditlog entry (if any) | keyword |
| adminbyrequest.events.computer_name | The computer name of the event | keyword |
| adminbyrequest.events.elevated_applications.file | The file name of the file executed | keyword |
| adminbyrequest.events.elevated_applications.name | The name of the application (description property of file) | keyword |
| adminbyrequest.events.elevated_applications.path | The file path of the executed application | keyword |
| adminbyrequest.events.elevated_applications.scan_result | Malware scan result (possible values - Clean, Malicious, Suspicious) | keyword |
| adminbyrequest.events.elevated_applications.scan_result_code | 0 = Clean, 1 = Malicious, 2 = Suspicious | keyword |
| adminbyrequest.events.elevated_applications.sha256 | The checksum of the file | keyword |
| adminbyrequest.events.elevated_applications.threat | Name of malware, if file is malicious or suspicious | keyword |
| adminbyrequest.events.elevated_applications.vendor | The vendor of the application | keyword |
| adminbyrequest.events.elevated_applications.version | The version of the file | keyword |
| adminbyrequest.events.elevated_applications.virustotal_link | Link to the file (checksum) on virustotal.com | keyword |
| adminbyrequest.events.event_code | The event code to uniquely identify this type of event; see list further down. The code can be used as filter | keyword |
| adminbyrequest.events.event_level | The severity level; 0 = Informational, 1 = Warning, 2 = Alert | keyword |
| adminbyrequest.events.event_text | Description of the event | text |
| adminbyrequest.events.event_time | Time of the event | date |
| adminbyrequest.events.event_time_utc | Event time in Coordinated Universal Time (UTC). Will default to eventTime if not available. | date |
| adminbyrequest.events.id | The unique ID of this entry. This ID can be used to query updated information on this entry by appending it to the url to request this resource only | keyword |
| adminbyrequest.events.rollback | Indicating if the event was rolled back. An example is a user adding a user to the local administrators group that was rolled back | boolean |
| adminbyrequest.events.scan_results.engine | Name of the antivirus engine with this result | keyword |
| adminbyrequest.events.scan_results.scan_result | Malware scan result (possible values - Clean, Malicious, Suspicious) | keyword |
| adminbyrequest.events.scan_results.scan_result_code | 0 = Clean, 1 = Malicious, 2 = Suspicious | keyword |
| adminbyrequest.events.scan_results.threat | Name of malware, if file is malicious or suspicious | keyword |
| adminbyrequest.events.user_account | The user's account name | keyword |
| adminbyrequest.events.user_name | The full name of the user | keyword |
| data_stream.dataset | Data stream dataset. | constant_keyword |
| data_stream.namespace | Data stream namespace. | constant_keyword |
| data_stream.type | Data stream type. | constant_keyword |
| event.dataset |  | constant_keyword |
