...
**Looking for guided configuration?** If you prefer configuring individual settings through the Fleet UI, consider using the [Prometheus Scrape via OTel (Guided)](https://github.com/elastic/integrations/tree/main/packages/prometheus_input_otel) package instead.
