...
The macOS Privileges integration collects and parses privilege-related events
from [macOS Privileges](https://github.com/SAP/macOS-enterprise-privileges) for macOS.
