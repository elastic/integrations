...
```json
{
    ...
    "agent": {
        "ephemeral_id": "00480237-584b-4874-900c-1ee82179d3ac",
        "id": "aca18834-90ec-4b18-8bd9-50466624ef53",
    ...
    "aws": {
        "s3": {
            "bucket": {
                "arn": "arn:aws:s3:::elastic-package-sentinel-one-bucket-11810",
                "name": "elastic-package-sentinel-one-bucket-11810"
            },
            "object": {
    ...
    "log": {
        "file": {
            "path": "https://elastic-package-sentinel-one-bucket-11810.s3.us-east-1.amazonaws.com/command_script.log"
        },
        "offset": 0
    },
    "powershell": {
