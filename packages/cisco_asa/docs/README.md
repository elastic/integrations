...
| cisco.asa.assigned_ipv6 | The IPv6 address assigned to a VPN client successfully connecting, when the session is assigned one in addition to an IPv4 address | ip |
