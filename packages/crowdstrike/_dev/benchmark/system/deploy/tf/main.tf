...
# Using this static file is a workaround required due to current elastic-package
# limitations outlined at:
      ...
      "files" : [
        {
          ...
          "size" : 1208306,
          "checksum" : "73ce284aa33a07467d947fa4d6087ca0"
        }
      ]
    })
  }
