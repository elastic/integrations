...
```json
{
    ...
    "agent": {
        "ephemeral_id": "318e76e5-8973-4d10-b7f1-198f55cfb7d3",
        "id": "c3e35d22-6994-4e5d-98aa-3edab22e3a3b",
...
| crowdstrike.alert.device.device_id |  | keyword |
