...
```json
{
    ...
    "agent": {
        "ephemeral_id": "dcced316-ac40-4182-8ecc-f07a95ddcd19",
    ...
    "event": {
        ...
        "created": "2023-09-22T00:40:29.584Z",
        "dataset": "proofpoint_tap.clicks_blocked",
        "id": "a5c9f8bb-1234-1234-1234-dx9xxx2xx9xxx",
        "ingested": "2023-09-22T00:40:30Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "330c29a2-6ef0-484f-a4bf-8efec49171d3",
        "id": "badbaba5-f530-4934-9eaa-c642f377fae2",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.8.1"
    ...
    "event": {
        ...
        "created": "2023-09-22T00:41:16.737Z",
        "dataset": "proofpoint_tap.clicks_permitted",
        "id": "de7eef56-1234-1234-1234-5xxfx7xxxdxxxx",
        "ingested": "2023-09-22T00:41:19Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "b0d6c92d-2a24-4fa4-b111-9981c7e4ec82",
        "id": "badbaba5-f530-4934-9eaa-c642f377fae2",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.8.1"
    ...
    "event": {
        ...
        "created": "2023-09-22T00:42:04.886Z",
        "dataset": "proofpoint_tap.message_blocked",
        "ingested": "2023-09-22T00:42:05Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "ce604e58-7fd5-4606-8527-65e39dca314f",
        "id": "badbaba5-f530-4934-9eaa-c642f377fae2",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.8.1"
    ...
    "event": {
        ...
        "created": "2023-09-22T00:42:52.873Z",
        "dataset": "proofpoint_tap.message_delivered",
        "id": "2hsvbU-i8abc123-12345-xxxxx12",
        "ingested": "2023-09-22T00:42:55Z",
        "kind": "event",
