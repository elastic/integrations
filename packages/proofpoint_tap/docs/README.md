...
```json
{
    ...
    "agent": {
        "ephemeral_id": "3c2248b7-b696-4e34-8f3f-82a36c169f2b",
        "id": "e8068652-8e83-48d7-b6eb-9b40cc8bce47",
        "name": "elastic-agent-15881",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T05:50:34.717Z",
        "dataset": "proofpoint_tap.clicks_blocked",
        "id": "a5c9f8bb-1234-1234-1234-dx9xxx2xx9xxx",
        "ingested": "2025-10-05T05:50:37Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "796d5e20-3f4e-447e-9e58-fc9644cc3dce",
        "id": "6684df32-72e8-4009-a16c-28195be221bf",
        "name": "elastic-agent-22967",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T05:51:35.999Z",
        "dataset": "proofpoint_tap.clicks_permitted",
        "id": "de7eef56-1234-1234-1234-5xxfx7xxxdxxxx",
        "ingested": "2025-10-05T05:51:38Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "04818a50-6b3c-4b06-9401-2d8effb662c4",
        "id": "10a540d3-1a7e-460d-ba0c-6108d3968b96",
        "name": "elastic-agent-85971",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T05:52:25.487Z",
        "dataset": "proofpoint_tap.message_blocked",
        "ingested": "2025-10-05T05:52:28Z",
        "kind": "event",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "66b80ebf-478e-47bd-9e2c-20db420f82f4",
        "id": "af7e2615-7dec-409d-8f21-219badc2d5eb",
        "name": "elastic-agent-71618",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T05:53:26.074Z",
        "dataset": "proofpoint_tap.message_delivered",
        "id": "2hsvbU-i8abc123-12345-xxxxx12",
        "ingested": "2025-10-05T05:53:29Z",
        "kind": "event",
