...
| island_browser.admin_actions.action_domain |  | keyword |
...
| island_browser.admin_actions.entity_id |  | keyword |
| island_browser.admin_actions.entity_name |  | keyword |
| island_browser.admin_actions.entity_type |  | keyword |
| island_browser.admin_actions.id |  | keyword |
...
| island_browser.admin_actions.timestamp |  | date |
| island_browser.admin_actions.updated_date |  | date |
| island_browser.admin_actions.user_id |  | keyword |
...
An example event for `admin_actions` looks as following:
...
```json
{
    ...
    "island_browser": {
        "admin_actions": {
            "action_domain": "SystemSettings",
            "action_type": "Create",
            "created_date": "2025-08-19T06:20:28.983Z",
            "email": "clark.kent@example.com",
            "entity_id": "fdaa9918-3f19-4596-8e9f-7bbec4ec5880",
            "entity_name": "Generic SIEM Integration",
            "entity_type": "SIEMConnector",
            "id": "ac93aaca-e464-4c8c-bdda-84bc227bb8c7",
            "source_ip": "89.160.20.128",
            "tenant_id": "elastic-testing",
            "timestamp": "2025-08-19T06:20:28.982Z",
            "updated_date": "2025-08-19T06:20:28.983Z",
            "user_id": "auth0|1e396c45-b365-4207-ae78-b35b10c06aaf"
        }
    },
    "organization": {
        "id": "elastic-testing"
    ...
    "related": {
        ...
        "user": [
            ...
            "auth0|1e396c45-b365-4207-ae78-b35b10c06aaf"
        ]
    },
    "source": {
        "geo": {
    ...
    "user": {
        "domain": "example.com",
        "email": "clark.kent@example.com",
        "id": "auth0|1e396c45-b365-4207-ae78-b35b10c06aaf"
    }
}
```
