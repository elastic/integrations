...
```json
{
    ...
    "agent": {
        "ephemeral_id": "328e7214-ad46-4700-99a7-3831292aa7b0",
        "hostname": "docker-fleet-agent",
        "id": "7a70525e-a73c-49f8-b7ae-258fe141c9ec",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "0bb9773f-dfb3-4423-a7ea-f30733f5ba19",
        "hostname": "docker-fleet-agent",
        "id": "7a70525e-a73c-49f8-b7ae-258fe141c9ec",
        "name": "docker-fleet-agent",
        "type": "filebeat",
