...
```json
{
    ...
    "agent": {
        "ephemeral_id": "047739ae-235e-41e1-bdb6-1a79d8ed2033",
        "hostname": "docker-fleet-agent",
        "id": "2622bbbd-01b6-461e-bb3d-c046d697b92d",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "dc0b19ae-b0ed-4b5e-97af-e1e79b157364",
        "hostname": "docker-fleet-agent",
        "id": "2622bbbd-01b6-461e-bb3d-c046d697b92d",
        "name": "docker-fleet-agent",
        "type": "filebeat",
