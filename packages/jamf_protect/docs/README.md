...
```json
{
    "@timestamp": "2024-04-23T10:50:06.179Z",
    "agent": {
        "ephemeral_id": "1a72c57a-9f06-4283-921a-441fa400d984",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "12530981-5a10-4e9f-bb9b-661c986296bd",
        "id": "bc9c17bf-519a-4e37-80cd-633fcea278e7",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.12.2"
