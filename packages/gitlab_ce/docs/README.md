...
| gitlab_ce.api.db_ci_duration_s |  | float |
| gitlab_ce.api.db_ci_replica_cached_count |  | long |
| gitlab_ce.api.db_ci_replica_count |  | long |
| gitlab_ce.api.db_ci_replica_duration_s |  | float |
| gitlab_ce.api.db_ci_replica_txn_count |  | long |
| gitlab_ce.api.db_ci_replica_txn_duration_s |  | float |
...
| gitlab_ce.api.db_main_txn_duration_s |  | float |
...
| gitlab_ce.api.db_primary_duration_s |  | float |
| gitlab_ce.api.db_primary_txn_count |  | long |
| gitlab_ce.api.db_primary_txn_duration_s |  | float |
...
| gitlab_ce.api.db_replica_duration_s |  | float |
| gitlab_ce.api.db_replica_txn_count |  | long |
| gitlab_ce.api.db_replica_txn_duration_s |  | float |
...
| gitlab_ce.api.duration_s |  | float |
...
| gitlab_ce.api.meta.remote_ip |  | ip |
...
| gitlab_ce.api.redis_db_load_balancing_duration_s |  | float |
| gitlab_ce.api.redis_db_load_balancing_write_bytes |  | long |
| gitlab_ce.api.redis_duration_s |  | float |
| gitlab_ce.api.redis_feature_flag_calls |  | long |
| gitlab_ce.api.redis_feature_flag_duration_s |  | float |
...
| gitlab_ce.api.redis_sessions_duration_s |  | float |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "6f50b81a-a20e-47c5-8072-61793d9b35f1",
        "id": "623b8ee0-c0fb-4235-abf8-2eb9931d2cb6",
...
| gitlab_ce.production.db_ci_duration_s |  | float |
| gitlab_ce.production.db_ci_replica_cached_count |  | long |
| gitlab_ce.production.db_ci_replica_count |  | long |
| gitlab_ce.production.db_ci_replica_duration_s |  | float |
| gitlab_ce.production.db_ci_replica_txn_count |  | long |
| gitlab_ce.production.db_ci_replica_txn_duration_s |  | float |
...
| gitlab_ce.production.db_ci_txn_duration_s |  | float |
...
| gitlab_ce.production.db_main_txn_duration_s |  | float |
...
| gitlab_ce.production.db_primary_duration_s |  | float |
| gitlab_ce.production.db_primary_txn_count |  | long |
| gitlab_ce.production.db_primary_txn_duration_s |  | float |
...
| gitlab_ce.production.db_replica_duration_s |  | float |
| gitlab_ce.production.db_replica_txn_count |  | long |
| gitlab_ce.production.db_replica_txn_duration_s |  | float |
...
| gitlab_ce.production.meta.remote_ip |  | ip |
...
| gitlab_ce.production.queue_duration_s |  | float |
...
| gitlab_ce.production.redis_cache_duration_s |  | float |
...
| gitlab_ce.production.redis_db_load_balancing_duration_s |  | float |
| gitlab_ce.production.redis_db_load_balancing_write_bytes |  | long |
| gitlab_ce.production.redis_duration_s |  | float |
| gitlab_ce.production.redis_feature_flag_calls |  | long |
| gitlab_ce.production.redis_feature_flag_duration_s |  | float |
...
| gitlab_ce.production.redis_queues_duration_s |  | float |
| gitlab_ce.production.redis_queues_metadata_calls |  | long |
| gitlab_ce.production.redis_queues_metadata_duration_s |  | float |
...
| gitlab_ce.production.redis_rate_limiting_duration_s |  | float |
...
| gitlab_ce.production.redis_sessions_duration_s |  | float |
...
| gitlab_ce.production.redis_shared_state_duration_s |  | float |
...
| gitlab_ce.production.remote_ip |  | ip |
| gitlab_ce.production.request_urgency |  | keyword |
| gitlab_ce.production.target_duration_s |  | float |
| gitlab_ce.production.time |  | keyword |
| gitlab_ce.production.view_duration_s |  | float |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "db03a0e4-dee2-4d0e-94c0-d4be7305693a",
        "id": "623b8ee0-c0fb-4235-abf8-2eb9931d2cb6",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.13.2"
