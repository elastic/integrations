...
*/}}
# GCP VPC Flow Logs OpenTelemetry Assets Integration for Elastic

## Overview
{{/* Complete this section with a short summary of what data this integration collects and what use cases it enables */}}
The GCP VPC Flow Logs OpenTelemetry Assets integration for Elastic enables collection of ...
...
The GCP VPC Flow Logs OpenTelemetry Assets integration collects log messages of the following types:
* ...
