...
| aws.bedrock_agentcore.body.request_payload.actor_id | Identifier of the actor initiating the request. | text |
| aws.bedrock_agentcore.body.request_payload.prompt | User prompt text extracted from the request payload. | text |
...
| aws.bedrock_agentcore.prompt_hash | Hash of the user prompt for deduplication and correlation. | text |
...
| aws.bedrock_agentcore.service_name | Name of the service handling the operation. | keyword |
...
| aws.bedrock_agentcore.severity_text | Textual representation of the severity level. | keyword |
...
| gen_ai.operation.name | Name of the GenAI operation performed. | keyword |
| gen_ai.provider.name | Name of the AI provider or platform. | keyword |
