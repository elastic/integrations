...
Microsoft Defender for Endpoint integration collects data for Alert, Baseline, Configuration, Information Gathering, Machine, Machine Action and Vulnerability logs using REST API.
...
- **[Baseline](https://learn.microsoft.com/en-us/defender-endpoint/api/export-security-baseline-assessment)** - Retrieves security baseline compliance assessment snapshots per device, profile, and configuration.
- **[Configuration](https://learn.microsoft.com/en-us/defender-endpoint/api/get-assessment-secure-config)** - Retrieves secure configuration assessment snapshots per device from the SecureConfigurationsAssessmentByMachine API.
- **[Information Gathering](https://learn.microsoft.com/en-us/defender-endpoint/api/get-assessment-information-gathering)** - Retrieves per-device TVM information gathering posture snapshots (AV health, emerging threat mitigations, and attack surface telemetry) via the InfoGatheringExport API.
...
- **[Vulnerability](https://learn.microsoft.com/en-us/defender-endpoint/api/get-assessment-software-vulnerabilities)** - Retrieves vulnerability change events (new, updated, and fixed) using the delta API.
...
| Baseline              | SecurityBaselinesAssessment.Read.All |
| Configuration         | Vulnerability.Read.All, Vulnerability.Read |
| Information Gathering | Vulnerability.Read.All, Vulnerability.Read |
...
```json
{
    ...
    "event": {
        ...
        "kind": "event",
        "original": "{\"id\":\"1212121212121212121212_red_hat_kernel_0:5.14.0-427.42.1.el9_4_CVE-2022-49226\",\"deviceId\":\"1212121212121212121212\",\"rbacGroupName\":\"Unassigned\",\"deviceName\":\"sample-host-1\",\"osPlatform\":\"Linux\",\"osVersion\":\"enterprise_linux_9.4\",\"osArchitecture\":\"x64\",\"softwareVendor\":\"red_hat\",\"softwareName\":\"kernel\",\"softwareVersion\":\"0:5.14.0-427.42.1.el9_4\",\"cveId\":\"CVE-2022-49226\",\"vulnerabilitySeverityLevel\":\"Medium\",\"recommendedSecurityUpdate\":\"CVE-2022-49226_oval:com.redhat.rhsa:def:20249315\",\"recommendedSecurityUpdateId\":\"RHSA-2024:9315\",\"recommendedSecurityUpdateUrl\":null,\"diskPaths\":[],\"registryPaths\":[],\"lastSeenTimestamp\":\"2026-05-20 22:45:00\",\"firstSeenTimestamp\":\"2026-05-20 10:43:58\",\"exploitabilityLevel\":\"NoExploit\",\"recommendationReference\":\"va-_-red_hat-_-kernel\",\"status\":\"New\",\"eventTimestamp\":\"2026-05-20 12:00:00\",\"cvssScore\":5.5,\"rbacGroupId\":0,\"isOnboarded\":true}",
        "type": [
            "info"
        ]
    },
...
| microsoft_defender_endpoint.vulnerability.event_timestamp | The time this delta event was found. | date |
...
| microsoft_defender_endpoint.vulnerability.status | Delta event status indicating whether the vulnerability is New, Fixed, or Updated. | keyword |
...
This is the `configuration` dataset.

#### Example

An example event for `configuration` looks as following:

```json
{
    "@timestamp": "2021-01-11T09:47:58.854Z",
    "agent": {
        "ephemeral_id": "71f8999a-aade-42de-b010-77e2fc0d9d46",
        "id": "3a23980c-e8c1-454d-acfc-91dfba80ae0d",
        "name": "elastic-agent-64172",
        "type": "filebeat",
        "version": "8.19.3"
    },
    "data_stream": {
        "dataset": "microsoft_defender_endpoint.configuration",
        "namespace": "79074",
        "type": "logs"
    },
    "ecs": {
    ...
    "event": {
        ...
        "dataset": "microsoft_defender_endpoint.configuration",
        "ingested": "2026-08-19T05:13:25Z",
        "kind": "event",
        "original": "{\"configurationCategory\":\"Network\",\"configurationId\":\"scid-10000\",\"configurationImpact\":5,\"configurationName\":\"Disable insecure administration protocol - Telnet\",\"configurationSubcategory\":\"\",\"deviceId\":\"00013ee62c6b12345b10214e1801b217b50ab455c293d\",\"deviceName\":\"srv-dc01.contoso.example\",\"isApplicable\":true,\"isCompliant\":true,\"isExpectedUserImpact\":false,\"osPlatform\":\"WindowsServer2019\",\"osVersion\":\"10.0.17763.2330\",\"rbacGroupName\":\"Production-Servers\",\"recommendationReference\":\"sca-_-scid-10000\",\"timestamp\":\"2021-01-11T09:47:58.854Z\"}",
        "type": [
            "info"
        ]
    },
    ...
    "host": {
        "id": "00013ee62c6b12345b10214e1801b217b50ab455c293d",
        "name": "srv-dc01.contoso.example",
        "os": {
            "platform": [
                "WindowsServer2019"
            ],
    ...
    "microsoft_defender_endpoint": {
        "configuration": {
            "configuration_category": "Network",
            "configuration_impact": 5,
            "is_applicable": true,
            "is_compliant": true,
            "is_expected_user_impact": false,
            "os_platform": "WindowsServer2019",
            "recommendation_reference": "sca-_-scid-10000"
        }
    },
    "observer": {
        "product": "Microsoft Defender for Endpoint",
    ...
    "related": {
        "hosts": [
            "00013ee62c6b12345b10214e1801b217b50ab455c293d",
            "srv-dc01.contoso.example"
        ]
    },
    "rule": {
        "id": "scid-10000",
    ...
    "tags": [
        "preserve_original_event",
        "forwarded",
        "microsoft_defender_endpoint-configuration"
    ]
}
```
...
| event.module | Name of the module this data is coming from. If your monitoring agent supports the concept of modules or plugins to process events of a given source (e.g. Apache logs), `event.module` should contain the name of this module. | constant_keyword |
| input.type | Type of Filebeat input. | keyword |
| microsoft_defender_endpoint.configuration.configuration_category | Category or grouping to which the configuration belongs, such as Application, OS, Network, Accounts, or Security controls. | keyword |
| microsoft_defender_endpoint.configuration.configuration_impact | Rated impact of the configuration to the overall configuration score (1-10). | long |
| microsoft_defender_endpoint.configuration.configuration_subcategory | Subcategory or subgrouping to which the configuration belongs. In many cases, this describes specific capabilities or features. | keyword |
| microsoft_defender_endpoint.configuration.is_applicable | Indicates whether the configuration or policy is applicable. | boolean |
| microsoft_defender_endpoint.configuration.is_compliant | Indicates whether the configuration or policy is properly configured. | boolean |
| microsoft_defender_endpoint.configuration.is_expected_user_impact | Indicates whether there will be user impact if the configuration will be applied. | boolean |
| microsoft_defender_endpoint.configuration.os_platform | Platform of the operating system running on the device. This indicates specific operating systems, including variations within the same family, such as Windows 10 and Windows 11. | keyword |
| microsoft_defender_endpoint.configuration.recommendation_reference | A reference to the recommendation ID related to this software. | keyword |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "91bafbb8-3521-4967-a893-63946eb7c761",
        "id": "d7a57e16-e520-4dba-99a4-4decc5c74036",
        "name": "elastic-agent-91187",
        "type": "filebeat",
        "version": "8.19.3"
    },
    "data_stream": {
        "dataset": "microsoft_defender_endpoint.baseline",
        "namespace": "48895",
        "type": "logs"
    },
    "ecs": {
    ...
    "event": {
        ...
        "created": "2026-08-10T08:15:02.478Z",
        "dataset": "microsoft_defender_endpoint.baseline",
        "id": "a1b2c3d4e5f6789012345678901234567890abcd_9e1b90be-e83e-485b-a5ec-4a429412e734_1.1.1",
        "ingested": "2026-08-19T05:14:54Z",
        "kind": "event",
        "original": "{\"complianceCalculationTimeOffset\":\"2026-08-10T09:00:00.000Z\",\"configurationId\":\"1.1.1\",\"currentValue\":[\"24\"],\"dataCollectionTimeOffset\":\"2026-08-10T08:15:02.478Z\",\"deviceId\":\"a1b2c3d4e5f6789012345678901234567890abcd\",\"deviceName\":\"srv-dc01.contoso.example\",\"id\":\"a1b2c3d4e5f6789012345678901234567890abcd_9e1b90be-e83e-485b-a5ec-4a429412e734_1.1.1\",\"isApplicable\":true,\"isCompliant\":false,\"osPlatform\":\"WindowsServer2019\",\"osVersion\":\"10.0.17763.2330\",\"profileId\":\"9e1b90be-e83e-485b-a5ec-4a429412e734\",\"rbacGroupId\":86,\"rbacGroupName\":\"Production-Servers\",\"recommendedValue\":[\"Greater than or equal '24'\"],\"source\":[\"password_hist_len\"]}",
        "type": [
            "info"
        ]
    },
    ...
    "host": {
        ...
        "name": "srv-dc01.contoso.example",
        "os": {
            "name": "WindowsServer2019 10.0.17763.2330",
            "platform": "WindowsServer2019",
            "type": "windows",
            "version": "10.0.17763.2330"
        }
    ...
    "microsoft_defender_endpoint": {
        "baseline": {
            ...
            "is_applicable": true,
            "is_compliant": false,
            "profile_id": "9e1b90be-e83e-485b-a5ec-4a429412e734",
            "recommended_value": [
    ...
    "tags": [
        "preserve_original_event",
        "forwarded",
        "microsoft_defender_endpoint-baseline"
    ]
}
```
...
| event.module | Name of the module this data is coming from. If your monitoring agent supports the concept of modules or plugins to process events of a given source (e.g. Apache logs), `event.module` should contain the name of this module. | constant_keyword |
| input.type | Type of Filebeat input. | keyword |
| microsoft_defender_endpoint.baseline.current_value | Set of detected values found on the device. | keyword |
| microsoft_defender_endpoint.baseline.is_applicable | Indicates whether the configuration is applicable to this device. | boolean |
| microsoft_defender_endpoint.baseline.is_compliant | Indicates whether the device is compliant with the configuration. | boolean |
| microsoft_defender_endpoint.baseline.profile_id | Unique identifier for the profile assessed. | keyword |
| microsoft_defender_endpoint.baseline.recommended_value | Set of expected values for the current device setting to be compliant. | keyword |
| microsoft_defender_endpoint.baseline.source | The registry path or other location used to determine the current device setting. | keyword |
| observer.product | The product name of the observer. | constant_keyword |
| observer.vendor | Vendor name of the observer. | constant_keyword |
...
An example event for `information_gathering` looks as following:

```json
{
    "@timestamp": "2026-08-31T20:30:00.000Z",
    "agent": {
        "ephemeral_id": "dcd6b968-f904-445c-a308-9e2ac7ce4249",
        "id": "0b06fe13-6909-42e1-9cff-8789dc326148",
        "name": "elastic-agent-27567",
        "type": "filebeat",
        "version": "8.19.3"
    },
    "data_stream": {
        "dataset": "microsoft_defender_endpoint.information_gathering",
        "namespace": "41200",
        "type": "logs"
    },
    "ecs": {
    ...
    "event": {
        ...
        "dataset": "microsoft_defender_endpoint.information_gathering",
        "ingested": "2026-09-07T07:10:32Z",
        "kind": "event",
        "original": "{\"DeviceGatheredInfo\":\"{\\\"AvMode\\\":null,\\\"Log4j_CVE_2021_44228\\\":null}\",\"DeviceId\":\"cccccccccccccccccccccccccccccccccccccccc\",\"DeviceName\":\"sample-host-3\",\"LastSeenTime\":\"2026-08-31 18:45:00\",\"OsPlatform\":\"Linux\",\"OsVersion\":\"enterprise_linux_9.4\",\"RbacGroupId\":42,\"RbacGroupName\":\"Production-Servers\",\"Timestamp\":\"2026-08-31 20:30:00\"}",
        "type": [
            "info"
        ]
    },
    ...
    "tags": [
        "preserve_original_event",
        "forwarded",
        "microsoft_defender_endpoint-information_gathering"
    ]
}
```
