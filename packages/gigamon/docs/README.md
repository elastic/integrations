...
```json
{
    ...
    "agent": {
        "ephemeral_id": "5a41244d-ec39-4883-ae8a-63c6e1df87fd",
        "id": "c4fcb05e-2a11-47cb-9757-427e425a8ec6",
        "name": "elastic-agent-67957",
        "type": "filebeat",
        "version": "8.18.2"
    },
    "data_stream": {
...
| gigamon.ami.tcp_client_mss |  | long |
| gigamon.ami.tcp_client_win_max |  | long |
| gigamon.ami.tcp_client_win_mean |  | long |
| gigamon.ami.tcp_client_win_min |  | long |
| gigamon.ami.tcp_client_zw |  | long |
| gigamon.ami.tcp_client_zw_ack |  | long |
| gigamon.ami.tcp_client_zw_probe |  | long |
| gigamon.ami.tcp_flag_reset |  | keyword |
| gigamon.ami.tcp_flags |  | keyword |
| gigamon.ami.tcp_loss_count |  | keyword |
| gigamon.ami.tcp_mss |  | long |
...
| gigamon.ami.tcp_server_mss |  | long |
| gigamon.ami.tcp_server_win_max |  | long |
| gigamon.ami.tcp_server_win_mean |  | long |
| gigamon.ami.tcp_server_win_min |  | long |
| gigamon.ami.tcp_server_zw |  | long |
| gigamon.ami.tcp_server_zw_ack |  | long |
| gigamon.ami.tcp_server_zw_probe |  | long |
| gigamon.ami.tcp_win_size |  | long |
