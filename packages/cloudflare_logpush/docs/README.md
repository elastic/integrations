...
```json
{
    ...
    "agent": {
        "ephemeral_id": "7e1f1899-b888-41e7-a00a-5650dface492",
        "id": "cd00e047-2fbb-4980-bd80-f832b3c46975",
        "name": "elastic-agent-71127",
        "type": "filebeat",
        "version": "8.17.1"
    },
    "cloud": {
    ...
    "log": {
        "file": {
            "path": "gs://testbucket/http_request.log"
        },
        "offset": 0
    },
    "network": {
