...
```json
{
    ...
    "agent": {
        "ephemeral_id": "f6fd2aea-505b-464e-9be1-c77256a8de7b",
        "id": "8ddb7cc7-b36b-428b-9d29-c02772236884",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.6.2"
    },
    "cloudflare_logpush": {
        "gateway_dns": {
            ...
            "device": {
                "id": "083a8354-d56c-11ed-9771-6a842b111cff",
                "name": "zt-test-vm1"
            },
            "event": {
                "timezone": "UTC"
            ...
            "timestamp": "2023-05-02T22:49:53.000Z",
            "timezone": {
                "inferred_method": "fromLocalTime"
            },
            "user": {
                "email": "user@test.com",
                "id": "166befbb-00e3-5e20-bd6e-27245323949f"
            }
        }
    },
    "data_stream": {
    ...
    "related": {
        ...
        "user": [
            "166befbb-00e3-5e20-bd6e-27245323949f",
            "user@test.com"
        ]
    },
    "source": {
    ...
    "tags": [
        ...
        "preserve_duplicate_custom_fields",
        "forwarded",
        "cloudflare_logpush_gateway_dns"
    ],
    "user": {
        "email": "user@test.com",
        "id": "166befbb-00e3-5e20-bd6e-27245323949f"
...
| cloudflare_logpush.gateway_dns.device.id | UUID of the device where the HTTP request originated from. | keyword |
| cloudflare_logpush.gateway_dns.device.name | The name of the device where the HTTP request originated from. | keyword |
| cloudflare_logpush.gateway_dns.event.timezone | Time zone used to calculate the current time, if a matched rule was scheduled with it. | keyword |
...
| cloudflare_logpush.gateway_dns.timezone.inferred_method | Method used to pick the time zone for the schedule. | keyword |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "e7d32278-29cf-4fc0-99a6-65d6b45e8b7c",
        "id": "aac9f566-072a-4a22-aba6-64ce125fa51f",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.6.2"
    },
    "cloudflare_logpush": {
        "network_session": {
            ...
            "session": {
                "end": "2023-05-04T11:29:14Z",
                "id": "18881f179300007fb0d06d6400000001",
                "start": "2023-05-04T11:29:14Z"
            },
            "source": {
                "bytes": 2333,
                "internal_ip": "67.43.156.2",
    ...
    "tags": [
        ...
        "preserve_duplicate_custom_fields",
        "forwarded",
        "cloudflare_logpush_network_session"
    ],
    "tls": {
        "server": {
            "issuer": "DigiCert Inc"
...
| cloudflare_logpush.network_session.device.id | Identifier of the client device which initiated the network session, if applicable. | keyword |
| cloudflare_logpush.network_session.device.name | Name of the client device which initiated the network session, if applicable. | keyword |
| cloudflare_logpush.network_session.egress.colo.name | The name of the Cloudflare colo from which traffic egressed to the origin. | keyword |
...
| cloudflare_logpush.network_session.ingress.colo.name | The name of the Cloudflare colo to which traffic ingressed. | keyword |
| cloudflare_logpush.network_session.network.transport | Network protocol used for this network session. | keyword |
...
```json
{
    "@timestamp": "2023-05-16T00:01:07.000Z",
    "agent": {
        "ephemeral_id": "6fb8d4a2-7437-459e-a48c-35beac3f927a",
        "id": "c74e6109-6e01-4a22-9185-c59af2f8da5b",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.6.2"
    },
    ...
    "event": {
        ...
        "dataset": "cloudflare_logpush.access_request",
        "id": "00c0ffeeabc12345",
        "ingested": "2023-05-17T13:13:40Z",
        "kind": "event",
        "original": "{\"Action\":\"login\",\"Allowed\":true,\"AppDomain\":\"example.com\",\"AppUUID\":\"123e4567-e89b-12d3-a456-426614174000\",\"Connection\":\"Google\",\"Country\":\"United States\",\"CreatedAt\":\"2023-05-16T00:01:07Z\",\"Email\":\"user@example.com\",\"IPAddress\":\"1.128.0.1\",\"PurposeJustificationPrompt\":\"Please provide your reason for accessing the application.\",\"PurposeJustificationResponse\":\"I need to access the application for work purposes.\",\"RayID\":\"00c0ffeeabc12345\",\"TemporaryAccessApprovers\":[\"approver1@example.com\",\"approver2@example.com\"],\"TemporaryAccessDuration\":7200,\"UserUID\":\"abc123\"}",
        "outcome": "success",
        "type": [
            "access"
        ]
    ...
    "tags": [
        ...
        "preserve_duplicate_custom_fields",
        "forwarded",
        "cloudflare_logpush_access_request"
    ],
    "url": {
        "domain": "example.com"
    },
...
| cloudflare_logpush.access_request.request.ray_id | Identifier of the request. | keyword |
