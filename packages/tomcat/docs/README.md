...
```json
{
    ...
    "agent": {
        "ephemeral_id": "a3fbc8f4-2834-4a98-a30e-9d5023d0194f",
        "id": "278931d4-1bf0-48cc-96d7-fef5881f952c",
...
| tomcat.localhost.subsystem | Indicates Tomcat’s subsystem or the type of the module that was the source of the message. For example, RBPM or Java Messaging Service (JMS). | keyword |
