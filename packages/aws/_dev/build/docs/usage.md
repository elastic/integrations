...
For example, you could use this data to view the number of the specified resources running in your account, Then you can alert the relevant budget holder about that usage by email.
