...
*_Note_:* Enabling the `include_linked_accounts` parameter requires appropriate permissions and authentication 
credentials for the linked accounts. Users should ensure that the necessary IAM roles and policies are properly set up 
to establish the necessary trust and access between accounts.
