...
> **Note:** Agentless deployment is currently supported for Network Firewall metrics only. Log collection is not available via agentless and requires a traditional Elastic Agent deployment.
