...
| aws.applicationelb.metrics.HTTPCode_Target_2XX_Count.sum | The number of HTTP 2XX response codes generated by the targets. This does not include any response codes generated by the load balancer. | long |  | gauge |
| aws.applicationelb.metrics.HTTPCode_Target_3XX_Count.sum | The number of HTTP 3XX response codes generated by the targets. This does not include any response codes generated by the load balancer. | long |  | gauge |
| aws.applicationelb.metrics.HTTPCode_Target_4XX_Count.sum | The number of HTTP 4XX response codes generated by the targets. This does not include any response codes generated by the load balancer. | long |  | gauge |
| aws.applicationelb.metrics.HTTPCode_Target_5XX_Count.sum | The number of HTTP 5XX response codes generated by the targets. This does not include any response codes generated by the load balancer. | long |  | gauge |
...
| aws.applicationelb.metrics.HealthyHostCount.max | The number of targets that are considered healthy. | long |  | gauge |
...
| aws.applicationelb.metrics.UnHealthyHostCount.max | The number of targets that are considered unhealthy. | long |  | gauge |
