...
> **Note:** Agentless deployment is currently supported for EMR metrics only. Log collection is not available via agentless and requires a traditional Elastic Agent deployment.
