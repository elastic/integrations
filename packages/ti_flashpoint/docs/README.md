...
```json
{
    ...
    "agent": {
        "ephemeral_id": "fb292815-193e-4385-b8fd-874bec678aa1",
        "id": "f8d04f25-1e2d-4a99-bdf0-3a210b15d23e",
        "name": "elastic-agent-81532",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "data_stream": {
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "a731b22a-997d-4b91-add8-54e3bcbed26e",
        "id": "464a3ca4-9a12-4a88-8083-7d2a364dc9d8",
        "name": "elastic-agent-10945",
        "type": "filebeat",
        "version": "8.18.0"
    },
    "data_stream": {
    ...
    "vulnerability": {
        ...
        "published_date": "2025-12-29T22:49:59.000Z",
        "reference": [
            "https://mattermost.com/security-updates/",
            "https://www.cisa.gov/news-events/bulletins/sb25-356",
            "https://www.cve.org/CVERecord?id=CVE-2025-13326"
        ],
        "scanner": {
            "vendor": "Flashpoint"
        },
