...
**Total Core Artifacts**: 47 available + 6 in progress= 53 total variants
**Total Queries**: 71
...
| 28  | Process Memory Map (Suspicious Analysis)   | ✅ | All   | process_memory_suspicious_elastic           | [a1b2](kibana/osquery_saved_query/osquery_manager-a1b2c3d4-mem1-11f0-8f39-bf9c07530bbb.json) | Comprehensive detection: W+X memory regions, unbacked executable regions, temp/hidden dirs, parent-child anomalies, PPID spoofing, protected process abuse (T1055) |
...
- ✅ **Process Injection Attempts** - Comprehensive memory analysis using `process_memory_map` combining W+X region detection, unbacked executable regions, temp/hidden directory execution, parent-child anomalies/PPID spoofing, and protected process abuse (T1055). Queries: `process_memory_suspicious_elastic`, `process_memory_modules_elastic`
