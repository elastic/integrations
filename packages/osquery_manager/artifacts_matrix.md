...
| # | Artifact                | ✓ | OS | Query | File | Velociraptor Artifact | Description |
|:-:|-------------------------|:-:|:--:|-------|:----:|-----------------------|-------------|
| 1 | Services                | ✅ | Win | suspicious_services | [003](kibana/osquery_saved_query/osquery_manager-892ee425-60e7-4eb6-ba25-6e97dc3e2ea0.json) | [Windows.System.Services](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/System/Services.yaml) | Detect suspicious services running from user-writable directories or with generic names commonly used by malware |
| 1a | Services                | ✅ | Mac | suspicious_launchd_macos | [043](kibana/osquery_saved_query/osquery_manager-5823a22e-5add-416d-a142-de323400edb0.json) | macOS equivalent | Detect suspicious launch daemons and agents on macOS, excluding system paths but flagging user-writable directories |
| 1b | Services                | ✅ | Linux | suspicious_systemd_linux | [044](kibana/osquery_saved_query/osquery_manager-f8b0894b-772d-4242-8e19-dbc5d7ae2e06.json) | Linux equivalent | Detect suspicious systemd units on Linux, excluding system paths but flagging user-writable directories and unusual locations |
| 2 | Scheduled Tasks         | ✅ | Win | scheduled_tasks_persistence | [004](kibana/osquery_saved_query/osquery_manager-bacf9b50-0f50-4c37-98d3-d6511b591826.json) | [Windows.System.TaskScheduler](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/System/TaskScheduler.yaml) | Identify enabled scheduled tasks executing from suspicious locations or using LOLBins |
| 2a | Scheduled Tasks         | ✅ | Mac+Linux | crontab_persistence | [045](kibana/osquery_saved_query/osquery_manager-b1c9c896-5306-4002-9699-519e8eee4ef5.json) | Unix/Linux equivalent | Detect suspicious crontab entries used for persistence (unified query for both platforms) |
| 3 | Startup Items           | ✅ | Win | startup_items_persistence | [005](kibana/osquery_saved_query/osquery_manager-749eba03-82e9-4dcc-89ea-f15074e1fb25.json) | [Windows.Sys.StartupItems](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/Sys/StartupItems.yaml) | Track startup items from registry and startup folders, focusing on non-Microsoft entries |
| 4 | Process Listing         | ✅ | All | suspicious_processes | [006](kibana/osquery_saved_query/osquery_manager-95c92ef6-1c38-4c27-8bbe-6fd849a0d96e.json) | [Windows.System.Pslist](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/System/Pslist.yaml) | Detect suspicious running processes including fileless malware and processes from temp folders |
| 5 | File Hashes             | ✅ | All | file_hashes_threat_intel | [008](kibana/osquery_saved_query/osquery_manager-017fb2f0-11e9-404e-a298-77542152a9be.json) | [Windows.KapeFiles.Targets](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/KapeFiles/Targets.yaml) | Enumerate recently modified executables with file hashes from suspicious locations |
| 6 | ARP Cache               | ✅ | All | arp_cache_lateral_movement | [009](kibana/osquery_saved_query/osquery_manager-064bd1eb-2ed0-4342-a1eb-a2c8e1bc017f.json) | [Windows.Network.ArpCache](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/Network/ArpCache.yaml) | Monitor ARP cache for lateral movement indicators |
| 7 | Network Connections     | ✅ | All | network_connections_c2 | [010](kibana/osquery_saved_query/osquery_manager-4846c0ca-1962-4692-830f-29451c486ff7.json) | Alternative approach | Identify active network connections to external IPs on common C2 and lateral movement ports |
| 8 | Registry                | ✅ | Win | registry_persistence | [012](kibana/osquery_saved_query/osquery_manager-6fdc0fa7-e318-4955-a280-8d799eccd27c.json) | [Windows.Registry.NTUser](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/Registry/NTUser.yaml) | Monitor Windows registry Run keys and startup locations for persistence mechanisms |
| 8a | Startup / Persistence   | ✅ | Mac | startup_items_persistence_macos | [046](kibana/osquery_saved_query/osquery_manager-ec67184a-3a16-4b6e-bb75-5575b7b1ec83.json) | macOS equivalent | Monitor macOS startup items for persistence mechanisms (equivalent to registry persistence) |
| 8b | Autostart / Persistence | ✅ | Linux | autostart_persistence_linux | [047](kibana/osquery_saved_query/osquery_manager-79e842cc-f15b-4316-9e44-7c99dbddb587.json) | Linux equivalent | Monitor Linux autostart mechanisms via user systemd units (equivalent to registry persistence) |
| 9 | LNK Files               | ✅ | Win | lnk_files_recent_activity | [017](kibana/osquery_saved_query/osquery_manager-517a3d18-53c4-4d31-98e8-4e5b799c0137.json) | [Windows.Forensics.Lnk](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/Forensics/Lnk.yaml) | Analyze LNK shortcut files showing recently accessed documents and programs |
| 10 | BITS Jobs               | ✅ | Win | bits_jobs_database | [041](kibana/osquery_saved_query/osquery_manager-8bb7af90-9eb2-4f06-8d3e-ba863804f462.json) | [Windows.EventLogs.Bitsadmin](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/EventLogs/Bitsadmin.yaml) | Detect suspicious BITS transfers by filtering out known-good domains (Microsoft, Google, Adobe, etc.) and internal networks - **Windows-only (no macOS/Linux equivalent)** |
| 11 | Network Interfaces      | ✅ | All | network_interfaces_baseline | [019](kibana/osquery_saved_query/osquery_manager-cafd7d30-52d9-495a-ba23-020e6fa06357.json) | [Generic.Network.InterfaceAddresses](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Generic/Network/InterfaceAddresses.yaml) | Document network configuration and identify anomalies like VPN or tunnel interfaces |
| 12 | Disk Info               | ✅ | Win | disk_drives_removable_windows | [030](kibana/osquery_saved_query/osquery_manager-09d80b84-b3a6-4ac4-a85b-bf1731c00e64.json) | [Windows.Sys.DiskInfo](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/Sys/DiskInfo.yaml) | Enumerate logical drives on Windows systems focusing on removable media and unusual volumes (uses logical_drives table) |
| 12a | Disk Info               | ✅ | Mac+Linux | mounts_removable | [048](kibana/osquery_saved_query/osquery_manager-334f0f0f-3d0a-40e2-b094-c844e419a968.json) | Unix/Linux equivalent | Enumerate mounted volumes focusing on removable media and external drives (unified query for both platforms) |
| 13 | AmCache                 | ⚠️ | Win | - | - | [Windows.System.Amcache](https://github.com/Velocidex/velociraptor/blob/master/artifacts/definitions/Windows/System/Amcache.yaml) | **Not Available** - PR #7261 closed due to SQL constraint problems. Alternative: Use Prefetch + File Hashes + Registry uninstall keys |
| 14 | Jumplists               | ⚠️ | Win | - | - | N/A (file enumeration) | **Not Available** - PR #7260 closed due to OLE format complexity. Alternative: File enumeration + Shellbags + Office MRU |
| 15 | Browser History         | ⚠️ | All | - | - | N/A (alternative approach) | **Not Available** - No native table, databases locked while browser running. Alternative: Downloads folder + cache analysis + ATC extension |
| 16 | MFT                     | ⚠️ | Win | - | - | N/A (alternative approach) | **Not Available** - Complex NTFS structure requires specialized parsing. Alternative: Trail of Bits extension + USN Journal + targeted queries |
| 17 | File Handles            | ⚠️ | All | - | - | N/A (sockets alternative) | **Not Available** - PR #7835 still open, not merged. Alternative: process_open_sockets + file table + eclecticiq extension |
