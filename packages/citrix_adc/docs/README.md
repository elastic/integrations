...
| citrix_adc.log.x_forwarded_for_ip | Originating client IP address reported by the X-Forwarded-For header when the client connects through a proxy. Also mapped to network.forwarded_ip. | ip |
