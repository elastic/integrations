...
| citrix_adc.log.ica_uuid | ICA session UUID extracted from the ICASTART message prefix (e.g. [ICAUUID=…]), used to correlate with the matching ICAEND_CONNSTAT event. | keyword |
