...
4. **Identify Team ID:** Navigate back to the **Settings** menu and select the **Team** tab, or visit the [Team Settings page](https://www.google.com/search?q=https://cloud.projectdiscovery.io/settings/team) directly.
