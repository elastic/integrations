...
```json
{
    ...
    "agent": {
        "ephemeral_id": "31077869-83df-46b0-b4e6-5b3f1e7449db",
        "id": "137c400a-7229-4b79-82aa-405e7c9e7152",
        "name": "elastic-agent-33567",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T08:04:56.397Z",
        "dataset": "ti_rapid7_threat_command.ioc",
        "ingested": "2025-10-05T08:04:57Z",
        "kind": "enrichment",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "c98baa05-3e82-45eb-8d65-9754546be71b",
        "id": "92094c39-9b43-407f-9978-250c60f7ba01",
        "name": "elastic-agent-43138",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        "agent_id_status": "verified",
        "created": "2025-10-05T08:28:06.851Z",
        "dataset": "ti_rapid7_threat_command.alert",
        "id": "123456789zxcvbnmas8a8q60",
        "ingested": "2025-10-05T08:28:07Z",
        "kind": "alert",
        "module": "ti_rapid7_threat_command",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "f034d144-8924-4786-b6ed-dcc61448ee46",
        "id": "35fece8f-aecb-4b32-b922-941ef87e6a40",
        "name": "elastic-agent-59182",
        "type": "filebeat",
        "version": "8.19.4"
    },
    "data_stream": {
    ...
    "event": {
        ...
        "created": "2025-10-05T08:05:43.287Z",
        "dataset": "ti_rapid7_threat_command.vulnerability",
        "ingested": "2025-10-05T08:05:46Z",
        "kind": "event",
        "module": "ti_rapid7_threat_command",
