...
| nginx.access.response_time | Time to serve the request in milliseconds. | long | ms |
...
The Nginx `stubstatus` stream was tested with Nginx 1.19.5 and 1.28.2. It is expected to work with all versions >= 1.19.
