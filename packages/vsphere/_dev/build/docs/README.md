...
### Virtual Machine Metrics
 ...
 Note: vSphere Integration currently supports network names of VM's conecected only to vSS (VSphere Standard Switch) and not vDS (VSphere Dustributed Switches).
