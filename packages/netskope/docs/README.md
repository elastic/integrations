...
```json
{
    ...
    "agent": {
        "ephemeral_id": "782427ef-f9f7-4943-8620-12ce3b1475c0",
        "id": "22afb33e-aabc-4700-9481-4b8db00d1428",
        "name": "elastic-agent-70873",
        "type": "filebeat",
        "version": "8.17.8"
    },
    "client": {
    ...
    "gcs": {
        "storage": {
            "bucket": {
                "name": "elastic-package-gcs-bucket-96590"
            },
            "object": {
    ...
    "log": {
        "file": {
            "path": "gs://elastic-package-gcs-bucket-96590/trxn.csv.gz"
        },
        "offset": 0
    },
    "netskope": {
