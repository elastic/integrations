...
| netskope.alerts.referer | Referer URL of the application(with http) that the user visited as provided by the log or data plane traffic. | flattened |
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "c7bacb22-2b42-42d8-8735-fbb18711d7d4",
        "id": "af9bbad1-73f6-43be-9e5d-738f7a55de3d",
...
```json
{
    ...
    "agent": {
        "ephemeral_id": "113d6b14-8d2e-48a3-b24d-867230783957",
        "id": "af9bbad1-73f6-43be-9e5d-738f7a55de3d",
        "name": "docker-fleet-agent",
        "type": "filebeat",
        "version": "8.3.0"
