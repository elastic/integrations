...
resource "google_storage_bucket" "gcs_netskope_transaction_bucket" {
...
resource "google_storage_bucket_object" "gcs_netskope_transaction_bucket_object" {
  name   = var.OBJECT_NAME
  bucket = google_storage_bucket.gcs_netskope_transaction_bucket.name
  source = var.FILE_PATH
}

output "gcs_netskope_transaction_bucket_name" {
  value = google_storage_bucket.gcs_netskope_transaction_bucket.name
}
