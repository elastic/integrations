...
| gen_ai.input.messages | Chat history provided to the model as input. | flattened |
| gen_ai.output.messages | Messages returned by the model for this invocation. | flattened |
