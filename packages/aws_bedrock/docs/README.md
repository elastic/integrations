...
The Amazon Bedrock integration enables seamless connection of your model invocation logging and runtime metrics to Elastic, allowing you to efficiently collect and monitor invocation logs and runtime metrics for usage monitoring.
