...
| aws.bedrock.artifacts |  | keyword |
| aws.bedrock.error |  | keyword |
| aws.bedrock.errorCode |  | keyword |
| aws.bedrock.imageGenerationConfig.cfgScale |  | double |
| aws.bedrock.imageGenerationConfig.height |  | long |
| aws.bedrock.imageGenerationConfig.numberOfImages |  | long |
| aws.bedrock.imageGenerationConfig.quality |  | keyword |
| aws.bedrock.imageGenerationConfig.seed |  | long |
| aws.bedrock.imageGenerationConfig.width |  | long |
| aws.bedrock.imageVariationParams.images |  | keyword |
| aws.bedrock.imageVariationParams.text |  | keyword |
| aws.bedrock.images |  | keyword |
| aws.bedrock.input.inputBodyJson |  | flattened |
| aws.bedrock.input.inputBodyS3Path |  | keyword |
| aws.bedrock.input.inputContentType |  | keyword |
| aws.bedrock.input.inputTokenCount | TODO | long |
| aws.bedrock.modelId |  | keyword |
| aws.bedrock.output.outputBodyJson |  | flattened |
| aws.bedrock.output.outputBodyS3Path |  | keyword |
| aws.bedrock.output.outputContentType |  | keyword |
| aws.bedrock.output.outputTokenCount |  | long |
| aws.bedrock.requestId |  | keyword |
| aws.bedrock.result |  | keyword |
| aws.bedrock.schemaType |  | keyword |
| aws.bedrock.schemaVersion |  | keyword |
| aws.bedrock.taskType |  | keyword |
