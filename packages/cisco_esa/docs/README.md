...
| cisco_esa.log.cache.exceptions | Cache Exceptions. | long |
...
| cisco_esa.log.delivered_recipients | Delivered Recipients. | long |
...
| cisco_esa.log.esa.sdr_consolidated_domain_age |  | text |
