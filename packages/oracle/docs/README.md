...
| oracle.tablespace.extended_space.free.bytes | Tablespace free extended size, in bytes. | long | byte | gauge |
| oracle.tablespace.extended_space.total.bytes | Tablespace total extended size, in bytes. | long | byte | gauge |
| oracle.tablespace.extended_space.used.bytes | Tablespace used extended size, in bytes. | long | byte | gauge |
| oracle.tablespace.name | Tablespace name | keyword |  |  |
| oracle.tablespace.query_id | Autogenerated ID representing the Oracle query that is executed to fetch the results. | keyword |  |  |
