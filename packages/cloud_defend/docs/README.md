...
| [group.name](https://www.elastic.co/guide/en/ecs/current/ecs-group.html#field-group-name) | 'root' |
...
| [process.entry_leader.group.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.group-name) | 'root' |
...
| [process.entry_leader.user.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.user-name) | 'root' |
...
| [process.group_leader.group.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.group-name) | 'root' |
...
| [process.group_leader.user.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.user-name) | 'root' |
...
| [process.parent.group.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.group-name) | 'root' |
...
| [process.parent.user.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.user-name) | 'root' |
...
| [process.session_leader.group.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.group-name) | 'root' |
...
| [process.session_leader.user.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process.user-name) | 'root' |
...
| [user.name](https://www.elastic.co/guide/en/ecs/current/ecs-user.html#field-user-name) | 'root' |
...
| [process.user.name](https://www.elastic.co/guide/en/ecs/current/ecs-process.html#field-process-user-name) | 'root' |
| [user.id](https://www.elastic.co/guide/en/ecs/current/ecs-user.html#field-user-id) | '0' |
| [user.name](https://www.elastic.co/guide/en/ecs/current/ecs-user.html#field-user-name) | 'root' |
