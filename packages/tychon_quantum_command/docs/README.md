...
| tychon.archive.encryption.strength |  | keyword |
| tychon.archive.encryption.type |  | keyword |
| tychon.archive.format.version |  | keyword |
| tychon.archive.type |  | keyword |
...
| tychon.macsec.cipher_suite |  | keyword |
| tychon.macsec.detection_confidence |  | keyword |
| tychon.macsec.detection_method |  | keyword |
| tychon.macsec.implementation |  | keyword |
| tychon.macsec.interface_name |  | keyword |
| tychon.macsec.key_agreement_method |  | keyword |
| tychon.macsec.parent_interface |  | keyword |
| tychon.macsec.risk_level |  | keyword |
| tychon.macsec.sci |  | keyword |
| tychon.macsec.status |  | keyword |
| tychon.macsec.validation_mode |  | keyword |
...
| tychon.server.protocol |  | keyword |
...
| tychon.tags | Vendor tags attached to the TQC record. | keyword |
...
| tychon.tls.previous_supported_ciphers | Cipher suites supported by the target in the previous TQC scan. | keyword |
| tychon.tls.previous_supported_key_exchanges | Key exchange algorithms supported by the target in the previous TQC scan. | keyword |
| tychon.tls.previous_supported_protocols | TLS protocol versions supported by the target in the previous TQC scan. | keyword |
