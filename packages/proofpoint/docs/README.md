...
An example event for `emailsecurity` looks as following:

```json
{
    "@timestamp": "2016-02-12T13:12:33.000Z",
    "agent": {
        "ephemeral_id": "db05338c-dad9-4f68-9a74-3a7381d816dc",
    ...
    "rsa": {
        "internal": {
            "messageid": "session_store"
        },
        "misc": {
            "client": "mipsumq",
            "event_source": "enatus",
            "log_session_id": "nibus",
            "obj_type": "gnaali",
            "rule_name": "mquia",
            "severity": "high"
        },
