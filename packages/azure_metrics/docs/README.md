...
| azure.compute_vm.available_memory_bytes.avg | Amount of physical memory, in bytes, immediately available for allocation to a process or for system use in the Virtual Machine | float | byte | gauge |
| azure.compute_vm.available_memory_percentage.avg | Amount of physical memory, as a percentage, immediately available for allocation to a process or for system use in the Virtual Machine | float | percent | gauge |
