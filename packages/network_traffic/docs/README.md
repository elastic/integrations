...
| tls.detailed.client_certificate_chain | Chain of trust for the client certificate. | flattened |
...
| tls.detailed.server_certificate_chain | Chain of trust for the server certificate. | flattened |
