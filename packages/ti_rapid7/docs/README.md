...
| rapid7.ioc.reported_feeds.name | Name of the reported feed. | keyword |
...
| rapid7.alert.id | Unique ID of an alert. | keyword |
...
| rapid7.vulnerability.cpe.value | Value of CPE. | keyword |
