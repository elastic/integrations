...
```json
{
    ...
    "agent": {
        "ephemeral_id": "d5a5a712-c503-48de-96df-7b5d93813de2",
        "hostname": "docker-fleet-agent",
        "id": "4df1fcdb-08e4-4f17-a523-5159ada47cb0",
    ...
    "log": {
        "file": {
            "path": "/tmp/service_logs/test-asa.log"
        },
        "level": "informational",
        "offset": 0
    },
