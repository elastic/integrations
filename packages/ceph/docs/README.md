...
Collect metrics related to cluster health.
...
Metrics give you insight into the statistics of the Ceph. The Metric data stream collected by the Ceph integration is `cluster_health` so that the user can monitor and troubleshoot the performance of the Ceph instance.
